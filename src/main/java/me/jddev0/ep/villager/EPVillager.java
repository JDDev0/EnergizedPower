...
public final class EPVillager {
    ...
    private static VillagerProfession registerProfession(String name, VillagerProfession profession) {
        return Registry.register(BuiltInRegistries.VILLAGER_PROFESSION, EPAPI.id(name), profession);
    }
    ...
    private static void addOffer(List<VillagerTrades.ItemListing> factories, ItemCost costA, ItemCost costB, ItemStack result,
        ...
        factories.add(((entity, rand) -> new MerchantOffer(costA, Optional.ofNullable(costB), result, maxUses, xp, priceMultiplier)));
    }
}
