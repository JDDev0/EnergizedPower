...
public final class ModConfigs {
    ...
    public static final ConfigValue<Long> COMMON_UHV_TRANSFORMERS_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_SUPERCONDUCTIVE_CABLE_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_ELITE_MINECART_CHARGER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.elite_minecart_charger", "Elite Minecart Charger", 67108864
    );
    public static final ConfigValue<Long> COMMON_ELITE_MINECART_CHARGER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.elite_minecart_charger", "Elite Minecart Charger", 8388608
    );

    public static final ConfigValue<Long> COMMON_ELITE_MINECART_UNCHARGER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.elite_minecart_uncharger", "Elite Minecart Uncharger", 67108864
    );
    public static final ConfigValue<Long> COMMON_ELITE_MINECART_UNCHARGER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_ELITE_AUTO_CRAFTER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.elite_auto_crafter", "Elite Auto Crafter", 8388608
    );
    public static final ConfigValue<Long> COMMON_ELITE_AUTO_CRAFTER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.elite_auto_crafter", "Elite Auto Crafter", 131072
    );
    public static final ConfigValue<Long> COMMON_ELITE_AUTO_CRAFTER_ENERGY_CONSUMPTION_PER_TICK_PER_INGREDIENT = COMMON_CONFIG.register(new LongConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_POWERED_FURNACE_FLUID_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_ADVANCED_POWERED_FURNACE_FLUID_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_ELITE_POWERED_FURNACE_CAPACITY = registerEnergyCapacityConfigValue(
            "block.elite_powered_furnace", "Elite Powered Furnace", 8388608
    );
    public static final ConfigValue<Long> COMMON_ELITE_POWERED_FURNACE_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.elite_powered_furnace", "Elite Powered Furnace", 131072
    );
    public static final ConfigValue<Long> COMMON_ELITE_POWERED_FURNACE_ENERGY_CONSUMPTION_PER_INPUT_PER_TICK = COMMON_CONFIG.register(new LongConfigValue(
            "block.elite_powered_furnace.energy_consumption_per_input_per_tick",
            "The energy consumption per input of the Elite Powered Furnace in E per tick.",
            16384L,
            1L, null
    ));
    ...
    public static final ConfigValue<Long> COMMON_ELITE_POWERED_FURNACE_FLUID_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_PLANT_GROWTH_CHAMBER_FLUID_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_FLUID_FREEZER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.fluid_freezer", "Fluid Freezer", 256
    );
    public static final ConfigValue<Long> COMMON_FLUID_FREEZER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
            "block.fluid_freezer", "Fluid Freezer", 128
    );
    public static final ConfigValue<Long> COMMON_FLUID_FREEZER_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Long> COMMON_ELITE_UNCHARGER_CAPACITY_PER_SLOT = COMMON_CONFIG.register(new LongConfigValue(
            "block.elite_uncharger.capacity_per_slot",
            "The energy capacity per slot of the Elite Uncharger in E.\n" +
                    "=> The energy capacity of the block is seven times this value.",
            2097152L,
            1L, null
    ));
    public static final ConfigValue<Long> COMMON_ELITE_UNCHARGER_TRANSFER_RATE_PER_SLOT = COMMON_CONFIG.register(new LongConfigValue(
            "block.elite_uncharger.transfer_rate_per_slot",
            "The energy transfer rate per slot of the Elite Uncharger in E per tick.\n" +
                    "=> The energy transfer rate of the block is seven times this value.",
            262144L,
            1L, null
    ));
