...
public final class ModConfigs {
    ...
    private static final String CONFIG_VERSION = "3.0.0-beta.9";
    ...
    public static final ConfigValue<Integer> COMMON_BATTERY_9_CAPACITY = registerEnergyCapacityConfigValue(
            "item.battery_9", "Battery (Tier IX)", 8388608
    );
    public static final ConfigValue<Integer> COMMON_BATTERY_9_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "item.battery_9", "Battery (Tier IX)", 262144
    );

    public static final ConfigValue<Integer> COMMON_BATTERY_10_CAPACITY = registerEnergyCapacityConfigValue(
            "item.battery_10", "Battery (Tier X)", 33554432
    );
    public static final ConfigValue<Integer> COMMON_BATTERY_10_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_UPGRADE_MODULE_DURATION_6_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_ELITE_BATTERY_BOX_CAPACITY = registerEnergyCapacityConfigValue(
            "block.elite_battery_box", "Elite Battery Box", 268435456
    );
    public static final ConfigValue<Integer> COMMON_ELITE_BATTERY_BOX_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.elite_battery_box", "Elite Battery Box", 16777216
    );

    public static final ConfigValue<Integer> COMMON_LV_TRANSFORMERS_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_TELEPORTER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.teleporter", "Teleporter", 8388608
    );
    public static final ConfigValue<Integer> COMMON_TELEPORTER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_SOLAR_PANEL_7_CAPACITY = registerEnergyCapacityConfigValue(
            "block.solar_panel_7", "Solar Panel (Tier VII)", 524288 * 8
    );
    public static final ConfigValue<Integer> COMMON_SOLAR_PANEL_7_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.solar_panel_7", "Solar Panel (Tier VII)", 524288 * 4
    );
    public static final ConfigValue<Integer> COMMON_SOLAR_PANEL_7_ENERGY_PEAK_PRODUCTION = registerEnergyPeakProductionConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_ELITE_MINECART_UNCHARGER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.elite_minecart_uncharger", "Elite Minecart Uncharger", 67108864
    );
    public static final ConfigValue<Integer> COMMON_ELITE_MINECART_UNCHARGER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.elite_minecart_uncharger", "Elite Minecart Uncharger", 8388608
    );
    ...
    public static final ConfigValue<Integer> COMMON_ADVANCED_CRUSHER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.advanced_crusher", "Advanced Crusher", 4096
    );
    public static final ConfigValue<Integer> COMMON_ADVANCED_CRUSHER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.advanced_crusher", "Advanced Crusher", 256
    );
    public static final ConfigValue<Integer> COMMON_ADVANCED_CRUSHER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_ADVANCED_CRUSHER_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_PULVERIZER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.pulverizer", "Pulverizer", 2048
    );
    public static final ConfigValue<Integer> COMMON_PULVERIZER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.pulverizer", "Pulverizer", 128
    );
    public static final ConfigValue<Integer> COMMON_PULVERIZER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_ADVANCED_PULVERIZER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.advanced_pulverizer", "Advanced Pulverizer", 4096
    );
    public static final ConfigValue<Integer> COMMON_ADVANCED_PULVERIZER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.advanced_pulverizer", "Advanced Pulverizer", 256
    );
    public static final ConfigValue<Integer> COMMON_ADVANCED_PULVERIZER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_ADVANCED_PULVERIZER_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
            "block.advanced_pulverizer", "Advanced Pulverizer", 8
    );
    public static final ConfigValue<Integer> COMMON_ADVANCED_PULVERIZER_WATER_USAGE_PER_RECIPE = COMMON_CONFIG.register(new IntegerConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_BLOCK_PLACER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.block_placer", "Block Placer", 2048
    );
    public static final ConfigValue<Integer> COMMON_BLOCK_PLACER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.block_placer", "Block Placer", 128
    );
    public static final ConfigValue<Integer> COMMON_BLOCK_PLACER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
    ...
    public static final ConfigValue<List<@NotNull ResourceLocation>> COMMON_ELITE_POWERED_FURNACE_RECIPE_BLACKLIST = registerRecipeBlacklistValue(
    ...
    public static final ConfigValue<Integer> COMMON_PLANT_GROWTH_CHAMBER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.plant_growth_chamber", "Plant Growth Chamber", 256
    );
    public static final ConfigValue<Integer> COMMON_PLANT_GROWTH_CHAMBER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_FLUID_FREEZER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.fluid_freezer", "Fluid Freezer", 256
    );
    public static final ConfigValue<Integer> COMMON_FLUID_FREEZER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
            "block.fluid_freezer", "Fluid Freezer", 128
    );
    public static final ConfigValue<Integer> COMMON_FLUID_FREEZER_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
            "block.fluid_freezer", "Fluid Freezer", 8
    );
    public static final ConfigValue<Integer> COMMON_FLUID_FREEZER_RECIPE_DURATION = registerRecipeDurationConfigValue(
            "block.fluid_freezer", "Fluid Freezer", 25
    );

    public static final ConfigValue<Integer> COMMON_STONE_LIQUEFIER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.stone_liquefier", "Stone Liquefier", 4096
    );
    public static final ConfigValue<Integer> COMMON_STONE_LIQUEFIER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.stone_liquefier", "Stone Liquefier", 256
    );
    public static final ConfigValue<Integer> COMMON_STONE_LIQUEFIER_ENERGY_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
            "block.stone_liquefier", "Stone Liquefier", 128
    );
    public static final ConfigValue<Integer> COMMON_STONE_LIQUEFIER_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_STONE_SOLIDIFIER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.stone_solidifier", "Stone Solidifier", 4096
    );
    public static final ConfigValue<Integer> COMMON_STONE_SOLIDIFIER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.stone_solidifier", "Stone Solidifier", 256
    );
    public static final ConfigValue<Integer> COMMON_STONE_SOLIDIFIER_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
            "block.stone_solidifier", "Stone Solidifier", 128
    );
    public static final ConfigValue<Integer> COMMON_STONE_SOLIDIFIER_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_FILTRATION_PLANT_CAPACITY = registerEnergyCapacityConfigValue(
            "block.filtration_plant", "Filtration Plant", 4096
    );
    public static final ConfigValue<Integer> COMMON_FILTRATION_PLANT_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.filtration_plant", "Filtration Plant", 256
    );
    public static final ConfigValue<Integer> COMMON_FILTRATION_PLANT_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
            "block.filtration_plant", "Filtration Plant", 128
    );
    public static final ConfigValue<Integer> COMMON_FILTRATION_PLANT_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_FILTRATION_PLANT_DIRTY_WATER_USAGE_PER_RECIPE = COMMON_CONFIG.register(new IntegerConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_FLUID_PUMP_CAPACITY = registerEnergyCapacityConfigValue(
            "block.fluid_pump", "Fluid Pump", 2048
    );
    public static final ConfigValue<Integer> COMMON_FLUID_PUMP_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
            "block.fluid_pump", "Fluid Pump", 128
    );
    public static final ConfigValue<Integer> COMMON_FLUID_PUMP_CONSUMPTION_PER_TICK = registerEnergyConsumptionPerTickConfigValue(
            "block.fluid_pump", "Fluid Pump", 32
    );
    public static final ConfigValue<Integer> COMMON_FLUID_PUMP_FLUID_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_IRON_FLUID_PIPE_FLUID_TRANSFER_RATE = registerFluidPipeTransferRateConfigValue(
            "block.iron_fluid_pipe", "Iron Fluid Pipe", 250
    );

    public static final ConfigValue<Integer> COMMON_GOLDEN_FLUID_PIPE_FLUID_TRANSFER_RATE = registerFluidPipeTransferRateConfigValue(
            "block.golden_fluid_pipe", "Golden Fluid Pipe", 1000
    );

    public static final ConfigValue<Integer> COMMON_STEEL_FLUID_PIPE_FLUID_TRANSFER_RATE = registerFluidPipeTransferRateConfigValue(
            "block.steel_fluid_pipe", "Steel Fluid Pipe", 2500
    );

    public static final ConfigValue<Integer> COMMON_PRESSURIZED_FLUID_PIPE_FLUID_TRANSFER_RATE = registerFluidPipeTransferRateConfigValue(
            "block.pressurized_fluid_pipe", "Pressurized Fluid Pipe", 10000
    );

    public static final ConfigValue<Integer> COMMON_FLUID_TANK_SMALL_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
            "block.fluid_tank_small", "Fluid Tank (Small)", 8
    );

    public static final ConfigValue<Integer> COMMON_FLUID_TANK_MEDIUM_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
            "block.fluid_tank_medium", "Fluid Tank (Medium)", 32
    );

    public static final ConfigValue<Integer> COMMON_FLUID_TANK_LARGE_TANK_CAPACITY = registerFluidTankCapacityConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_CHARGER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_ELITE_CHARGER_CAPACITY_PER_SLOT = COMMON_CONFIG.register(new IntegerConfigValue(
            "block.elite_charger.capacity_per_slot",
            "The energy capacity per slot of the Elite Charger in FE.\n" +
                    "=> The energy capacity of the block is seven times this value.",
            2097152,
            1, null
    ));
    public static final ConfigValue<Integer> COMMON_ELITE_CHARGER_TRANSFER_RATE_PER_SLOT = COMMON_CONFIG.register(new IntegerConfigValue(
            "block.elite_charger.transfer_rate_per_slot",
            "The energy transfer rate per slot of the Elite Charger in FE per tick.\n" +
                    "=> The energy transfer rate of the block is seven times this value.",
            262144,
            1, null
    ));
    public static final ConfigValue<Float> COMMON_ELITE_CHARGER_CHARGER_RECIPE_ENERGY_CONSUMPTION_MULTIPLIER = COMMON_CONFIG.register(new FloatConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_UNCHARGER_CAPACITY = registerEnergyCapacityConfigValue(
            "block.uncharger", "Uncharger", 8192
    );
    public static final ConfigValue<Integer> COMMON_UNCHARGER_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    public static final ConfigValue<Integer> COMMON_ELITE_BATTERY_BOX_MINECART_CAPACITY = registerEnergyCapacityConfigValue(
            "block.elite_battery_box_minecart", "Elite Battery Box Minecart", 268435456
    );
    public static final ConfigValue<Integer> COMMON_ELITE_BATTERY_BOX_MINECART_TRANSFER_RATE = registerEnergyTransferRateConfigValue(
    ...
    //Misc
    public static final ConfigValue<Integer> COMMON_XP_TO_LIQUID_RATIO = COMMON_CONFIG.register(new IntegerConfigValue(
            "xp_to_liquid_ratio",
            "The amount of liquid XP in mB (milli Buckets) which is equivalent to 1 XP point.\n" +
                    "If this value is changed, the Fluid Transposer recipe for the Experience Bottle should be changed too (12.5 * xp_to_liquid_ratio [Default: 250])",
            20,
            1, null
    ));
    ...
    private static ConfigValue<Integer> registerFluidPipeTransferRateConfigValue(String baseConfigKey, String itemName, int defaultValue) {
        return COMMON_CONFIG.register(new IntegerConfigValue(
    ...
    private static void upgradeIronFluidPipeTransferRate() {
        ...
        try {
            int value = COMMON_IRON_FLUID_PIPE_FLUID_TRANSFER_RATE.getValue();
            if(value == 100) {
                COMMON_IRON_FLUID_PIPE_FLUID_TRANSFER_RATE.setValue(250);
