...
public class EnergizedPowerMod implements ModInitializer {
	...
	private void addCreativeTab() {
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB_REG_KEY, ModBlocks.FLUID_TRANSPOSER_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB_REG_KEY, ModBlocks.FLUID_PUMP_ITEM);
        ...
        addEmptyAndFullyChargedItem(ModCreativeModeTab.ENERGIZED_POWER_TAB_REG_KEY, ModItems.INVENTORY_TELEPORTER, InventoryTeleporterItem.CAPACITY);
