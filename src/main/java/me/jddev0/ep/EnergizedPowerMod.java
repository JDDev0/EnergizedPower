...
public class EnergizedPowerMod implements ModInitializer {
	...
	private void addCreativeTab() {
		...
		addEmptyAndFullyChargedItem(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.FLUID_ANALYZER, FluidAnalyzerItem.ENERGY_CAPACITY);
        ...
        addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.CUTTER);
        ...
        addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.ITEM_CONVEYOR_BELT_LOADER_ITEM);
        addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.ITEM_CONVEYOR_BELT_SORTER_ITEM);
        addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.ITEM_CONVEYOR_BELT_SWITCH_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.LV_TRANSFORMER_1_TO_N_ITEM);
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.LV_TRANSFORMER_3_TO_3_ITEM);
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.LV_TRANSFORMER_N_TO_1_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.PRESS_MOLD_MAKER_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.SOLAR_PANEL_ITEM_6);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.POWERED_LAMP_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.METAL_PRESS_ITEM);
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.ASSEMBLING_MACHINE_ITEM);
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.PLANT_GROWTH_CHAMBER_ITEM);
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.STONE_SOLIDIFIER_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.DRAIN_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.CRYSTAL_GROWTH_CHAMBER_ITEM);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModBlocks.TELEPORTER_ITEM);

		addEmptyAndFullyChargedItem(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.INVENTORY_COAL_ENGINE, InventoryCoalEngineItem.CAPACITY);
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.INVENTORY_CHARGER);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.REINFORCED_ADVANCED_SOLAR_CELL);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.PROCESSING_UNIT);

		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.TELEPORTER_PROCESSING_UNIT);
		...
		addToCreativeTab(ModCreativeModeTab.ENERGIZED_POWER_TAB, ModItems.GOLD_DUST);
