...
public class EnergizedPowerREIPlugin implements REICommonPlugin {
    ...
    public void registerDisplays(ServerDisplayRegistry registry) {
        ...
        registry.beginRecipeFiller(FluidFreezerRecipe.class).filterType(EPRecipes.FLUID_FREEZER_TYPE).fill(FluidFreezerDisplay::new);
        registry.beginRecipeFiller(StoneLiquefierRecipe.class).filterType(EPRecipes.STONE_LIQUEFIER_TYPE).fill(StoneLiquefierDisplay::new);
    ...
    public void registerDisplaySerializer(DisplaySerializerRegistry registry) {
        ...
        registry.register(FluidFreezerDisplay.CATEGORY.getIdentifier(), FluidFreezerDisplay.SERIALIZER);
