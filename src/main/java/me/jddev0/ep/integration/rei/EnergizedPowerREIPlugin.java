...
public class EnergizedPowerREIPlugin implements REIClientPlugin {
    ...
    public void registerCategories(CategoryRegistry registry) {
        ...
        registry.addWorkstations(BuiltinPlugin.CRAFTING, EntryStacks.of(EPBlocks.ELITE_AUTO_CRAFTER_ITEM.get()));
        ...
        registry.addWorkstations(BuiltinPlugin.SMELTING, EntryStacks.of(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstations(BuiltinPlugin.BLASTING, EntryStacks.of(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstations(BuiltinPlugin.SMOKING, EntryStacks.of(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()));
        ...
        registry.addWorkstations(ChargerCategory.CATEGORY, EntryStacks.of(EPBlocks.CHARGER_ITEM.get()),
                EntryStacks.of(EPBlocks.ADVANCED_CHARGER_ITEM.get()), EntryStacks.of(EPBlocks.ELITE_CHARGER_ITEM.get()));
        ...
        registry.add(new FluidFreezerCategory());
        registry.addWorkstations(FluidFreezerDisplay.CATEGORY, EntryStacks.of(EPBlocks.FLUID_FREEZER_ITEM));
        ...
        registry.addWorkstations(InWorldCategory.CATEGORY, EntryIngredients.ofItemTag(Tags.Items.TOOLS_SHEAR));
    ...
    public void registerDisplays(DisplayRegistry registry) {
        ...
        registry.registerRecipeFiller(FluidFreezerRecipe.class, EPRecipes.FLUID_FREEZER_TYPE.get(), FluidFreezerDisplay::new);
    ...
    public void registerScreens(ScreenRegistry registry) {
        ...
        registerRecipeClickArea(registry, new Rectangle(83, 43, 24, 17),
                FluidFreezerScreen.class, FluidFreezerDisplay.CATEGORY);
