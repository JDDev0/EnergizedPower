...
public class FluidFreezerCategory implements DisplayCategory<FluidFreezerDisplay> {
    private static final int PADDING = 5;

    @Override
    public CategoryIdentifier<? extends FluidFreezerDisplay> getCategoryIdentifier() {
        return FluidFreezerDisplay.CATEGORY;
    }
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EPBlocks.FLUID_FREEZER_ITEM.get());
    }

    @Override
    public List<Widget> setupDisplay(FluidFreezerDisplay display, Rectangle bounds) {
    ...
    @Override
    public int getDisplayWidth(FluidFreezerDisplay display) {
        return 82 + 2*PADDING;
    }
