...
public class EnergizerCategory implements DisplayCategory<EnergizerDisplay> {
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EPBlocks.ENERGIZER_ITEM);
    }
    ...
    public List<Widget> setupDisplay(EnergizerDisplay display, Rectangle bounds) {
        ...
        long energyConsumption = (long)(display.recipe().value().getEnergyConsumption() * EnergizerBlockEntity.ENERGY_CONSUMPTION_MULTIPLIER);
