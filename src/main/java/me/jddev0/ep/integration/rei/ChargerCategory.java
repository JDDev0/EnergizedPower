...
public class ChargerCategory implements DisplayCategory<ChargerDisplay> {
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EPBlocks.CHARGER_ITEM);
    }
    ...
    public List<Widget> setupDisplay(ChargerDisplay display, Rectangle bounds) {
        ...
        long energyConsumption = (long)(display.recipe().getEnergyConsumption() * ChargerBlockEntity.CHARGER_RECIPE_ENERGY_CONSUMPTION_MULTIPLIER);
