...
public class PlantGrowthChamberFertilizerEMIRecipe implements EmiRecipe {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        Text speedMultiplierText = new TranslatableText("recipes.energizedpower.plant_growth_chamber_fertilizer.speed_multiplier", speedMultiplier);
        ...
        Text energyConsumptionMultiplierText = new TranslatableText("recipes.energizedpower.plant_growth_chamber_fertilizer.energy_consumption_multiplier", energyConsumptionMultiplier);
