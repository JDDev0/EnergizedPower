...
public class AlloyFurnaceEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = ResourceLocation.fromNamespaceAndPath(EnergizedPowerMod.MODID, "textures/block/alloy_furnace_front.png");
    public static final EmiStack ITEM = EmiStack.of(ModBlocks.ALLOY_FURNACE_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(ResourceLocation.fromNamespaceAndPath(EnergizedPowerMod.MODID, "alloy_furnace"),
