...
public class PressMoldMakerEMIRecipe implements EmiRecipe {
    public static final Identifier SIMPLIFIED_TEXTURE = new Identifier(EnergizedPowerMod.MODID, "textures/block/press_mold_maker_front.png");
    public static final EmiStack ITEM = EmiStack.of(ModBlocks.PRESS_MOLD_MAKER_ITEM);
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(new Identifier(EnergizedPowerMod.MODID, "press_mold_maker"),
    ...
    public PressMoldMakerEMIRecipe(PressMoldMakerRecipe recipe) {
        ...
        this.input = List.of(EmiIngredient.of(Ingredient.ofItems(Items.CLAY_BALL), recipe.getClayCount()));
