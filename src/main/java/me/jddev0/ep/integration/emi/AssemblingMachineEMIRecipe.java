...
public class AssemblingMachineEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = ResourceLocation.fromNamespaceAndPath(EnergizedPowerMod.MODID, "textures/block/assembling_machine_front.png");
    public static final EmiStack ITEM = EmiStack.of(ModBlocks.ASSEMBLING_MACHINE_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(ResourceLocation.fromNamespaceAndPath(EnergizedPowerMod.MODID, "assembling_machine"),
