...
public class EnergizedPowerEMIPlugin implements EmiPlugin {
    ...
    private void registerCategories(EmiRegistry registry) {
        ...
        registry.addWorkstation(VanillaEmiRecipeCategories.CRAFTING, EmiStack.of(EPBlocks.ELITE_AUTO_CRAFTER_ITEM.get()));
        ...
        registry.addWorkstation(VanillaEmiRecipeCategories.SMELTING, EmiStack.of(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstation(VanillaEmiRecipeCategories.BLASTING, EmiStack.of(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstation(VanillaEmiRecipeCategories.SMOKING, EmiStack.of(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()));
        ...
        registry.addWorkstation(ChargerEMIRecipe.CATEGORY, EmiStack.of(EPBlocks.ELITE_CHARGER_ITEM.get()));
    ...
    private void registerRecipeHandlers(EmiRegistry registry) {
        ...
        registry.addRecipeHandler(EPMenuTypes.ELITE_AUTO_CRAFTER_MENU.get(), new EliteAutoCrafterRecipeHandler());
