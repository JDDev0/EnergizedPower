...
public class EliteAutoCrafterRecipeHandler implements EmiRecipeHandler<EliteAutoCrafterMenu> {
    @Override
    public EmiPlayerInventory getInventory(AbstractContainerScreen<EliteAutoCrafterMenu> screen) {
    ...
    @Override
    public boolean canCraft(EmiRecipe recipe, EmiCraftContext<EliteAutoCrafterMenu> context) {
        return recipe.getInputs().size() <= 9;
    }

    @Override
    public boolean craft(EmiRecipe recipe, EmiCraftContext<EliteAutoCrafterMenu> context) {
