...
public class CrusherEMIRecipe implements EmiRecipe {
    public static final Identifier SIMPLIFIED_TEXTURE = Identifier.of(EnergizedPowerMod.MODID, "textures/block/crusher_side.png");
    public static final EmiStack ITEM = EmiStack.of(ModBlocks.CRUSHER_ITEM);
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(Identifier.of(EnergizedPowerMod.MODID, "crusher"),
    ...
    public void addWidgets(WidgetHolder widgets) {
        Identifier texture = Identifier.of(EnergizedPowerMod.MODID, "textures/gui/container/crusher.png");
