...
public class CrystalGrowthChamberCategory implements IRecipeCategory<CrystalGrowthChamberRecipe> {
    public static final Identifier UID = EPAPI.id("crystal_growth_chamber");
    ...
    @Override
    public void draw(CrystalGrowthChamberRecipe recipe, IRecipeSlotsView iRecipeSlotsView, DrawContext guiGraphics, double mouseX, double mouseY) {
