...
public class PlantGrowthChamberFertilizerCategory implements IRecipeCategory<RecipeEntry<PlantGrowthChamberFertilizerRecipe>> {
    public static final RecipeType<RecipeEntry<PlantGrowthChamberFertilizerRecipe>> TYPE = RecipeType.createFromVanilla(PlantGrowthChamberFertilizerRecipe.Type.INSTANCE);
    ...
    @Override
    public RecipeType<RecipeEntry<PlantGrowthChamberFertilizerRecipe>> getRecipeType() {
        return TYPE;
    }
