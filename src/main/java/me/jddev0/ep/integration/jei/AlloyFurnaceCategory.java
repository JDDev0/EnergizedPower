...
public class AlloyFurnaceCategory implements IRecipeCategory<AlloyFurnaceRecipe> {
    public static final Identifier UID = EPAPI.id("alloy_furnace");
    ...
    @Override
    public void draw(AlloyFurnaceRecipe recipe, IRecipeSlotsView iRecipeSlotsView, DrawContext guiGraphics, double mouseX, double mouseY) {
