...
public class FluidTransposerCategory implements IRecipeCategory<RecipeEntry<FluidTransposerRecipe>> {
    public static final RecipeType<RecipeEntry<FluidTransposerRecipe>> TYPE = RecipeType.createFromVanilla(FluidTransposerRecipe.Type.INSTANCE);
    ...
    @Override
    public RecipeType<RecipeEntry<FluidTransposerRecipe>> getRecipeType() {
        return TYPE;
    }
