...
public class AdvancedAutoCrafterTransferHandler implements IRecipeTransferHandler<AdvancedAutoCrafterMenu, CraftingRecipe> {
    ...
    @Override
    public @Nullable IRecipeTransferError transferRecipe(AdvancedAutoCrafterMenu container, CraftingRecipe recipe, IRecipeSlotsView recipeSlots, PlayerEntity player,
        ...
        ModMessages.sendClientPacketToServer(new SetAdvancedAutoCrafterPatternInputSlotsC2SPacket(container.getBlockEntity().getPos(), itemStacks, recipe.getId()));
