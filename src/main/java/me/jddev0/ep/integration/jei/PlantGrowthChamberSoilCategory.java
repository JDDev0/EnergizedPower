...
public class PlantGrowthChamberSoilCategory implements IRecipeCategory<RecipeHolder<PlantGrowthChamberSoilRecipe>> {
    public static final RecipeType<RecipeHolder<PlantGrowthChamberSoilRecipe>> TYPE = RecipeType.createFromVanilla(PlantGrowthChamberSoilRecipe.Type.INSTANCE);
    ...
    @Override
    public RecipeType<RecipeHolder<PlantGrowthChamberSoilRecipe>> getRecipeType() {
        return TYPE;
    }
    ...
    @Override
    public void draw(RecipeHolder<PlantGrowthChamberSoilRecipe> recipe, IRecipeSlotsView iRecipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(font, component, 1, 52, 0xFFFFFFFF, true);
        ...
        guiGraphics.drawString(font, component, 1, 67, 0xFFFFFFFF, true);
    }
}
