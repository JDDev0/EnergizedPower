...
public class PulverizerCategory implements IRecipeCategory<RecipeEntry<PulverizerRecipe>> {
    public static final RecipeType<RecipeEntry<PulverizerRecipe>> TYPE = RecipeType.createFromVanilla(PulverizerRecipe.Type.INSTANCE);
    ...
    public PulverizerCategory(IGuiHelper helper) {
        ...
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(EPBlocks.PULVERIZER_ITEM));
    }
