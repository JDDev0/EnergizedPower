...
public class EnergizedPowerJEIPlugin implements IModPlugin {
    ...
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        ...
        registration.addRecipeTransferHandler(new SelectableRecipeMachineTransferHandler<>(
                registration.getTransferHelper(), FluidFreezerMenu.class,
                        EPMenuTypes.FLUID_FREEZER_MENU),
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addCraftingStation(RecipeTypes.CRAFTING, new ItemStack(EPBlocks.ELITE_AUTO_CRAFTER_ITEM));
        ...
        registration.addCraftingStation(RecipeTypes.SMELTING, new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM));
        registration.addCraftingStation(RecipeTypes.BLASTING, new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM));
        registration.addCraftingStation(RecipeTypes.SMOKING, new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM));
        ...
        registration.addCraftingStation(PlantGrowthChamberSoilCategory.TYPE, new ItemStack(EPBlocks.PLANT_GROWTH_CHAMBER_ITEM));
        ...
        registration.addCraftingStation(FluidFreezerCategory.TYPE, new ItemStack(EPBlocks.FLUID_FREEZER_ITEM));
