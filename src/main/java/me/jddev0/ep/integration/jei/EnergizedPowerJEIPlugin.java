...
public class EnergizedPowerJEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(FluidFreezerCategory.TYPE, recipeManager.getAllRecipesFor(FluidFreezerRecipe.Type.INSTANCE));
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()), RecipeTypes.SMELTING);
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()), RecipeTypes.BLASTING);
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM.get()), RecipeTypes.SMOKING);
        ...
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_CHARGER_ITEM.get()), ChargerCategory.TYPE);
        ...
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.PLANT_GROWTH_CHAMBER_ITEM.get()), PlantGrowthChamberSoilCategory.TYPE);
        ...
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.FLUID_FREEZER_ITEM.get()), FluidFreezerCategory.TYPE);
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        ...
        registerRecipeClickArea(registration, AdvancedPoweredFurnaceScreen.class, 43, 34, 18, 18, RecipeTypes.SMELTING,
                RecipeTypes.BLASTING, RecipeTypes.SMOKING);
        registerRecipeClickArea(registration, AdvancedPoweredFurnaceScreen.class, 79, 34, 18, 18, RecipeTypes.SMELTING,
                RecipeTypes.BLASTING, RecipeTypes.SMOKING);
