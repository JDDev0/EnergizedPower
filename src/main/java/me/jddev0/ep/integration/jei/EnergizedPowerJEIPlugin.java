...
public class EnergizedPowerJEIPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_AUTO_CRAFTER_ITEM), RecipeTypes.CRAFTING);
        ...
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM), RecipeTypes.SMELTING);
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM), RecipeTypes.BLASTING);
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.ELITE_POWERED_FURNACE_ITEM), RecipeTypes.SMOKING);
        ...
        registration.addRecipeCatalyst(new ItemStack(EPBlocks.FLUID_FREEZER_ITEM), FluidFreezerCategory.TYPE);
