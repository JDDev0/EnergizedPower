...
public class EnergizedPowerJEIPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addCraftingStation(RecipeTypes.CRAFTING, new ItemStack(EPBlocks.ELITE_AUTO_CRAFTER_ITEM.get()));
        ...
        registration.addCraftingStation(ChargerCategory.TYPE, new ItemStack(EPBlocks.ELITE_CHARGER_ITEM.get()));
