...
public class CompressorCategory implements IRecipeCategory<RecipeHolder<CompressorRecipe>> {
    ...
    @Override
    public IRecipeType<RecipeHolder<CompressorRecipe>> getRecipeType() {
        return TYPE;
    }
    ...
    @Override
    public void draw(RecipeHolder<CompressorRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
