...
public class InputOutputFluidStorage implements ResourceHandler<FluidResource> {
    ...
    public InputOutputFluidStorage(ResourceHandler<FluidResource> handler, BiPredicate<Integer, FluidStack> canInput, Predicate<Integer> canOutput) {
