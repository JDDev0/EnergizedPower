...
public final class ModMessages {
    ...
    public static void register() {
        ...
        net.messageBuilder(SetCurrentRecipeIdC2SPacket.class, id(), PlayNetworkDirection.PLAY_TO_SERVER).
        ...
        net.messageBuilder(SetCreativeFluidTankFluidStackC2SPacket.class, id(), PlayNetworkDirection.PLAY_TO_SERVER).
