...
public class InventoryTeleporterItem extends EnergizedPowerEnergyItem implements MenuProvider {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag type) {
        ...
        tooltip.add(Component.translatable("tooltip.energizedpower.teleporter_matrix.status").withStyle(ChatFormatting.GRAY).
        ...
        if(linked) {
            ...
            tooltip.add(Component.translatable("tooltip.energizedpower.teleporter_matrix.location").
                    append(Component.literal(dimPos.x() + " " + dimPos.y() + " " + dimPos.z())));
            tooltip.add(Component.translatable("tooltip.energizedpower.teleporter_matrix.dimension").
        ...
        if(Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("tooltip.energizedpower.inventory_teleporter.txt.shift.1").
                    withStyle(ChatFormatting.GRAY, ChatFormatting.ITALIC));
            tooltip.add(Component.translatable("tooltip.energizedpower.inventory_teleporter.txt.shift.2").
                    withStyle(ChatFormatting.GRAY, ChatFormatting.ITALIC));
        }else {
