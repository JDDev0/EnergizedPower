...
public class AdvancedBatteryBoxMinecartItem extends Item {
    private static final ItemDispenserBehavior DISPENSE_ITEM_BEHAVIOR = new ItemDispenserBehavior() {
        ...
        public ItemStack dispenseSilently(BlockPointer blockSource, ItemStack itemStack) {
            ...
            if(itemStack.hasCustomName())
                minecartAdvancedBatteryBox.setCustomName(itemStack.getName());

            level.spawnEntity(minecartAdvancedBatteryBox);
            itemStack.decrement(1);
            return itemStack;
        }
    };

    public AdvancedBatteryBoxMinecartItem(FabricItemSettings props) {
        super(props);
    ...
    public ActionResult useOnBlock(ItemUsageContext useOnContext) {
        ...
        if(!level.isClient) {
            ...
            MinecartAdvancedBatteryBox minecartAdvancedBatteryBox = new MinecartAdvancedBatteryBox(level, blockPos.getX() + .5,
