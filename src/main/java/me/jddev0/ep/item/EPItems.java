...
public final class EPItems {
    ...
    public static final Item ENERGIZED_COPPER_INGOT = registerItem("energized_copper_ingot",
            new Item(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    ...
    public static final Item STONE_PEBBLE = registerItem("stone_pebble",
            new Item(new Item.Settings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    ...
    public static final Item GEAR_PRESS_MOLD = registerItem("gear_press_mold",
            new Item(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxDamage(2000)));
    ...
    public static final Item TELEPORTER_MATRIX = registerItem("teleporter_matrix",
            new TeleporterMatrixItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    ...
    public static Item SPEED_UPGRADE_MODULE_1 = registerItem("speed_upgrade_module_1",
            new SpeedUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static Item SPEED_UPGRADE_MODULE_2 = registerItem("speed_upgrade_module_2",
            new SpeedUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static Item SPEED_UPGRADE_MODULE_3 = registerItem("speed_upgrade_module_3",
            new SpeedUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 3));
    public static Item SPEED_UPGRADE_MODULE_4 = registerItem("speed_upgrade_module_4",
            new SpeedUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 4));
    public static Item SPEED_UPGRADE_MODULE_5 = registerItem("speed_upgrade_module_5",
            new SpeedUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 5));

    public static Item ENERGY_EFFICIENCY_UPGRADE_MODULE_1 = registerItem("energy_efficiency_upgrade_module_1",
            new EnergyEfficiencyUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static Item ENERGY_EFFICIENCY_UPGRADE_MODULE_2 = registerItem("energy_efficiency_upgrade_module_2",
            new EnergyEfficiencyUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static Item ENERGY_EFFICIENCY_UPGRADE_MODULE_3 = registerItem("energy_efficiency_upgrade_module_3",
            new EnergyEfficiencyUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 3));
    public static Item ENERGY_EFFICIENCY_UPGRADE_MODULE_4 = registerItem("energy_efficiency_upgrade_module_4",
            new EnergyEfficiencyUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 4));
    public static Item ENERGY_EFFICIENCY_UPGRADE_MODULE_5 = registerItem("energy_efficiency_upgrade_module_5",
            new EnergyEfficiencyUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 5));

    public static Item ENERGY_CAPACITY_UPGRADE_MODULE_1 = registerItem("energy_capacity_upgrade_module_1",
            new EnergyCapacityUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static Item ENERGY_CAPACITY_UPGRADE_MODULE_2 = registerItem("energy_capacity_upgrade_module_2",
            new EnergyCapacityUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static Item ENERGY_CAPACITY_UPGRADE_MODULE_3 = registerItem("energy_capacity_upgrade_module_3",
            new EnergyCapacityUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 3));
    public static Item ENERGY_CAPACITY_UPGRADE_MODULE_4 = registerItem("energy_capacity_upgrade_module_4",
            new EnergyCapacityUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 4));
    public static Item ENERGY_CAPACITY_UPGRADE_MODULE_5 = registerItem("energy_capacity_upgrade_module_5",
            new EnergyCapacityUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 5));

    public static Item DURATION_UPGRADE_MODULE_1 = registerItem("duration_upgrade_module_1",
            new DurationUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static Item DURATION_UPGRADE_MODULE_2 = registerItem("duration_upgrade_module_2",
            new DurationUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static Item DURATION_UPGRADE_MODULE_3 = registerItem("duration_upgrade_module_3",
            new DurationUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 3));
    public static Item DURATION_UPGRADE_MODULE_4 = registerItem("duration_upgrade_module_4",
            new DurationUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 4));
    public static Item DURATION_UPGRADE_MODULE_5 = registerItem("duration_upgrade_module_5",
            new DurationUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 5));
    public static Item DURATION_UPGRADE_MODULE_6 = registerItem("duration_upgrade_module_6",
            new DurationUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 6));

    public static Item RANGE_UPGRADE_MODULE_1 = registerItem("range_upgrade_module_1",
            new RangeUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static Item RANGE_UPGRADE_MODULE_2 = registerItem("range_upgrade_module_2",
            new RangeUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static Item RANGE_UPGRADE_MODULE_3 = registerItem("range_upgrade_module_3",
            new RangeUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 3));

    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_1 = registerItem("extraction_depth_upgrade_module_1",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_2 = registerItem("extraction_depth_upgrade_module_2",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_3 = registerItem("extraction_depth_upgrade_module_3",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 3));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_4 = registerItem("extraction_depth_upgrade_module_4",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 4));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_5 = registerItem("extraction_depth_upgrade_module_5",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 5));

    public static Item BLAST_FURNACE_UPGRADE_MODULE = registerItem("blast_furnace_upgrade_module",
            new FurnaceModeUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static Item SMOKER_UPGRADE_MODULE = registerItem("smoker_upgrade_module",
            new FurnaceModeUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));

    public static Item MOON_LIGHT_UPGRADE_MODULE_1 = registerItem("moon_light_upgrade_module_1",
            new MoonLightUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static Item MOON_LIGHT_UPGRADE_MODULE_2 = registerItem("moon_light_upgrade_module_2",
            new MoonLightUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static Item MOON_LIGHT_UPGRADE_MODULE_3 = registerItem("moon_light_upgrade_module_3",
            new MoonLightUpgradeModuleItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB), 3));

    public static final Item ENERGIZED_POWER_BOOK = registerItem("energized_power_book",
            new EnergizedPowerBookItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));

    public static final Item CABLE_INSULATOR = registerItem("cable_insulator",
            new CableInsulatorItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));

    public static final Item CHARCOAL_FILTER = registerItem("charcoal_filter",
            new Item(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxDamage(200).maxDamageIfAbsent(200)));
    ...
    public static final Item INVENTORY_COAL_ENGINE = registerItem("inventory_coal_engine",
            new InventoryCoalEngineItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));

    public static final Item INVENTORY_CHARGER = registerItem("inventory_charger",
            new InventoryChargerItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));

    public static final Item INVENTORY_TELEPORTER = registerItem("inventory_teleporter",
            new InventoryTeleporterItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));
    ...
    public static final Item CREATIVE_BATTERY = registerItem("creative_battery",
            new CreativeBatteryItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));
    ...
    public static final Item ENERGY_ANALYZER = registerItem("energy_analyzer",
            new EnergyAnalyzerItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));

    public static final Item FLUID_ANALYZER = registerItem("fluid_analyzer",
            new FluidAnalyzerItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));

    public static final Item WOODEN_HAMMER = registerItem("wooden_hammer",
            new HammerItem(ToolMaterials.WOOD, new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final Item STONE_HAMMER = registerItem("stone_hammer",
            new HammerItem(ToolMaterials.STONE, new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final Item IRON_HAMMER = registerItem("iron_hammer",
            new HammerItem(ToolMaterials.IRON, new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final Item GOLDEN_HAMMER = registerItem("golden_hammer",
            new HammerItem(ToolMaterials.GOLD, new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final Item DIAMOND_HAMMER = registerItem("diamond_hammer",
            new HammerItem(ToolMaterials.DIAMOND, new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final Item NETHERITE_HAMMER = registerItem("netherite_hammer",
            new HammerItem(ToolMaterials.NETHERITE, new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).fireproof()));

    public static final Item CUTTER = registerItem("cutter",
            new CutterItem(ToolMaterials.IRON, new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB)));

    public static final Item WRENCH = registerItem("wrench",
            new WrenchItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));

    public static final Item BATTERY_BOX_MINECART = registerItem("battery_box_minecart",
            new BatteryBoxMinecartItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));
    public static final Item ADVANCED_BATTERY_BOX_MINECART = registerItem("advanced_battery_box_minecart",
            new AdvancedBatteryBoxMinecartItem(new FabricItemSettings().group(EPCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));
