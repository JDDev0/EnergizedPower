...
public final class EPItems {
    ...
    public static final DeferredItem<Item> ENERGIZED_ALLOY_INGOT = registerItem("energized_alloy_ingot",
    ...
    public static final DeferredItem<Item> ENERGIZED_ALLOY_PLATE = registerItem("energized_alloy_plate");
    ...
    private static DeferredItem<Item> registerPressMoldItem(String name, int maxDamage) {
        return registerItem(name, maxDamage > 0?new Item.Properties().durability(maxDamage):new Item.Properties());
    }
    public static final DeferredItem<Item> BASIC_GEAR_PRESS_MOLD = registerPressMoldItem("gear_press_mold",
            ModConfigs.COMMON_BASIC_GEAR_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> HARDENED_GEAR_PRESS_MOLD = registerPressMoldItem("hardened_gear_press_mold",
            ModConfigs.COMMON_HARDENED_GEAR_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> ADVANCED_GEAR_PRESS_MOLD = registerPressMoldItem("advanced_gear_press_mold",
            ModConfigs.COMMON_ADVANCED_GEAR_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> ELITE_GEAR_PRESS_MOLD = registerPressMoldItem("elite_gear_press_mold",
            ModConfigs.COMMON_ELITE_GEAR_PRESS_MOLD_MAX_DURABILITY.getValue());

    public static final DeferredItem<Item> BASIC_ROD_PRESS_MOLD = registerPressMoldItem("rod_press_mold",
            ModConfigs.COMMON_BASIC_ROD_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> HARDENED_ROD_PRESS_MOLD = registerPressMoldItem("hardened_rod_press_mold",
            ModConfigs.COMMON_HARDENED_ROD_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> ADVANCED_ROD_PRESS_MOLD = registerPressMoldItem("advanced_rod_press_mold",
            ModConfigs.COMMON_ADVANCED_ROD_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> ELITE_ROD_PRESS_MOLD = registerPressMoldItem("elite_rod_press_mold",
            ModConfigs.COMMON_ELITE_ROD_PRESS_MOLD_MAX_DURABILITY.getValue());

    public static final DeferredItem<Item> BASIC_WIRE_PRESS_MOLD = registerPressMoldItem("wire_press_mold",
            ModConfigs.COMMON_BASIC_WIRE_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> HARDENED_WIRE_PRESS_MOLD = registerPressMoldItem("hardened_wire_press_mold",
            ModConfigs.COMMON_HARDENED_WIRE_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> ADVANCED_WIRE_PRESS_MOLD = registerPressMoldItem("advanced_wire_press_mold",
            ModConfigs.COMMON_ADVANCED_WIRE_PRESS_MOLD_MAX_DURABILITY.getValue());
    public static final DeferredItem<Item> ELITE_WIRE_PRESS_MOLD = registerPressMoldItem("elite_wire_press_mold",
    ...
    public static final DeferredItem<Item> SPEED_UPGRADE_MODULE_7 = registerItem("speed_upgrade_module_7",
            props -> new SpeedUpgradeModuleItem(props, 7));
    public static final DeferredItem<Item> SPEED_UPGRADE_MODULE_8 = registerItem("speed_upgrade_module_8",
            props -> new SpeedUpgradeModuleItem(props, 8));

    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_1 = registerItem("energizing_speed_upgrade_module_1",
            props -> new EnergizingSpeedUpgradeModuleItem(props, 1));
    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_2 = registerItem("energizing_speed_upgrade_module_2",
            props -> new EnergizingSpeedUpgradeModuleItem(props, 2));
    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_3 = registerItem("energizing_speed_upgrade_module_3",
            props -> new EnergizingSpeedUpgradeModuleItem(props, 3));
    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_4 = registerItem("energizing_speed_upgrade_module_4",
            props -> new EnergizingSpeedUpgradeModuleItem(props, 4));
    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_5 = registerItem("energizing_speed_upgrade_module_5",
            props -> new EnergizingSpeedUpgradeModuleItem(props, 5));
    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_6 = registerItem("energizing_speed_upgrade_module_6",
            props -> new EnergizingSpeedUpgradeModuleItem(props, 6));
    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_7 = registerItem("energizing_speed_upgrade_module_7",
            props -> new EnergizingSpeedUpgradeModuleItem(props, 7));
    public static final DeferredItem<Item> ENERGIZING_SPEED_UPGRADE_MODULE_8 = registerItem("energizing_speed_upgrade_module_8",
    ...
    public static final DeferredItem<Item> ENERGY_EFFICIENCY_UPGRADE_MODULE_7 = registerItem("energy_efficiency_upgrade_module_7",
            props -> new EnergyEfficiencyUpgradeModuleItem(props, 7));
    public static final DeferredItem<Item> ENERGY_EFFICIENCY_UPGRADE_MODULE_8 = registerItem("energy_efficiency_upgrade_module_8",
            props -> new EnergyEfficiencyUpgradeModuleItem(props, 8));
    ...
    public static final DeferredItem<Item> ENERGY_PRODUCTION_UPGRADE_MODULE_7 = registerItem("energy_production_upgrade_module_7",
            props -> new EnergyProductionUpgradeModuleItem(props, 7));
    public static final DeferredItem<Item> ENERGY_PRODUCTION_UPGRADE_MODULE_8 = registerItem("energy_production_upgrade_module_8",
            props -> new EnergyProductionUpgradeModuleItem(props, 8));
    ...
    public static final DeferredItem<Item> ENERGY_CAPACITY_UPGRADE_MODULE_7 = registerItem("energy_capacity_upgrade_module_7",
            props -> new EnergyCapacityUpgradeModuleItem(props, 7));
    public static final DeferredItem<Item> ENERGY_CAPACITY_UPGRADE_MODULE_8 = registerItem("energy_capacity_upgrade_module_8",
            props -> new EnergyCapacityUpgradeModuleItem(props, 8));
    ...
    public static final DeferredItem<Item> MOON_LIGHT_UPGRADE_MODULE_4 = registerItem("moon_light_upgrade_module_4",
            props -> new MoonLightUpgradeModuleItem(props, 4));
    public static final DeferredItem<Item> MOON_LIGHT_UPGRADE_MODULE_5 = registerItem("moon_light_upgrade_module_5",
            props -> new MoonLightUpgradeModuleItem(props, 5));

    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_1 = registerItem("item_ejector_upgrade_module_1",
            props -> new ItemEjectorUpgradeModuleItem(props, 1));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_2 = registerItem("item_ejector_upgrade_module_2",
            props -> new ItemEjectorUpgradeModuleItem(props, 2));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_3 = registerItem("item_ejector_upgrade_module_3",
            props -> new ItemEjectorUpgradeModuleItem(props, 3));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_4 = registerItem("item_ejector_upgrade_module_4",
            props -> new ItemEjectorUpgradeModuleItem(props, 4));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_5 = registerItem("item_ejector_upgrade_module_5",
            props -> new ItemEjectorUpgradeModuleItem(props, 5));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_6 = registerItem("item_ejector_upgrade_module_6",
            props -> new ItemEjectorUpgradeModuleItem(props, 6));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_7 = registerItem("item_ejector_upgrade_module_7",
            props -> new ItemEjectorUpgradeModuleItem(props, 7));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_8 = registerItem("item_ejector_upgrade_module_8",
            props -> new ItemEjectorUpgradeModuleItem(props, 8));

    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_1 = registerItem("item_pulling_upgrade_module_1",
            props -> new ItemPullingUpgradeModuleItem(props, 1));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_2 = registerItem("item_pulling_upgrade_module_2",
            props -> new ItemPullingUpgradeModuleItem(props, 2));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_3 = registerItem("item_pulling_upgrade_module_3",
            props -> new ItemPullingUpgradeModuleItem(props, 3));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_4 = registerItem("item_pulling_upgrade_module_4",
            props -> new ItemPullingUpgradeModuleItem(props, 4));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_5 = registerItem("item_pulling_upgrade_module_5",
    ...
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_7 = registerItem("item_pulling_upgrade_module_7",
            props -> new ItemPullingUpgradeModuleItem(props, 7));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_8 = registerItem("item_pulling_upgrade_module_8",
    ...
    public static final DeferredItem<Item> ELITE_BATTERY_BOX_MINECART = registerItem("elite_battery_box_minecart",
