...
public final class EPItems {
    ...
    public static final DeferredItem<Item> ENERGY_PRODUCTION_UPGRADE_MODULE_2 = ITEMS.register("energy_production_upgrade_module_2",
            () -> new EnergyProductionUpgradeModuleItem(new Item.Properties(), 2));
    public static final DeferredItem<Item> ENERGY_PRODUCTION_UPGRADE_MODULE_3 = ITEMS.register("energy_production_upgrade_module_3",
            () -> new EnergyProductionUpgradeModuleItem(new Item.Properties(), 3));
    public static final DeferredItem<Item> ENERGY_PRODUCTION_UPGRADE_MODULE_4 = ITEMS.register("energy_production_upgrade_module_4",
    ...
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_1 = ITEMS.register("item_ejector_upgrade_module_1",
            () -> new ItemEjectorUpgradeModuleItem(new Item.Properties(), 1));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_2 = ITEMS.register("item_ejector_upgrade_module_2",
            () -> new ItemEjectorUpgradeModuleItem(new Item.Properties(), 2));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_3 = ITEMS.register("item_ejector_upgrade_module_3",
            () -> new ItemEjectorUpgradeModuleItem(new Item.Properties(), 3));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_4 = ITEMS.register("item_ejector_upgrade_module_4",
            () -> new ItemEjectorUpgradeModuleItem(new Item.Properties(), 4));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_5 = ITEMS.register("item_ejector_upgrade_module_5",
            () -> new ItemEjectorUpgradeModuleItem(new Item.Properties(), 5));
    public static final DeferredItem<Item> ITEM_EJECTOR_UPGRADE_MODULE_6 = ITEMS.register("item_ejector_upgrade_module_6",
            () -> new ItemEjectorUpgradeModuleItem(new Item.Properties(), 6));

    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_1 = ITEMS.register("item_pulling_upgrade_module_1",
            () -> new ItemPullingUpgradeModuleItem(new Item.Properties(), 1));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_2 = ITEMS.register("item_pulling_upgrade_module_2",
            () -> new ItemPullingUpgradeModuleItem(new Item.Properties(), 2));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_3 = ITEMS.register("item_pulling_upgrade_module_3",
            () -> new ItemPullingUpgradeModuleItem(new Item.Properties(), 3));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_4 = ITEMS.register("item_pulling_upgrade_module_4",
            () -> new ItemPullingUpgradeModuleItem(new Item.Properties(), 4));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_5 = ITEMS.register("item_pulling_upgrade_module_5",
            () -> new ItemPullingUpgradeModuleItem(new Item.Properties(), 5));
    public static final DeferredItem<Item> ITEM_PULLING_UPGRADE_MODULE_6 = ITEMS.register("item_pulling_upgrade_module_6",
