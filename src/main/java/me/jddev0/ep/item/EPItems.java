...
public final class EPItems {
    ...
    public static  <T extends Item> T registerItem(String name, Function<Item.Properties, T> factory, Item.Properties props) {
        return Registry.register(BuiltInRegistries.ITEM, EPAPI.id(name), factory.apply(props));
    }
    ...
    public static final Item QUANTUM_PROCESSING_UNIT = registerItem("quantum_processing_unit");
    ...
    public static final Item ELITE_UPGRADE_MODULE = registerItem("elite_upgrade_module");
    ...
    public static final Item SPEED_UPGRADE_MODULE_7 = registerItem("speed_upgrade_module_7",
    ...
    public static final Item ENERGY_EFFICIENCY_UPGRADE_MODULE_7 = registerItem("energy_efficiency_upgrade_module_7",
            props -> new EnergyEfficiencyUpgradeModuleItem(props, 7));
    public static final Item ENERGY_EFFICIENCY_UPGRADE_MODULE_8 = registerItem("energy_efficiency_upgrade_module_8",
    ...
    public static final Item ENERGY_PRODUCTION_UPGRADE_MODULE_7 = registerItem("energy_production_upgrade_module_7",
            props -> new EnergyProductionUpgradeModuleItem(props, 7));
    public static final Item ENERGY_PRODUCTION_UPGRADE_MODULE_8 = registerItem("energy_production_upgrade_module_8",
    ...
    public static final Item ENERGY_CAPACITY_UPGRADE_MODULE_7 = registerItem("energy_capacity_upgrade_module_7",
            props -> new EnergyCapacityUpgradeModuleItem(props, 7));
    public static final Item ENERGY_CAPACITY_UPGRADE_MODULE_8 = registerItem("energy_capacity_upgrade_module_8",
    ...
    public static final Item XP_EXTRACTION_UPGRADE_MODULE_2 = registerItem("xp_extraction_upgrade_module_2",
            props -> new XPExtractionUpgradeModuleItem(props, 2));
    public static final Item XP_EXTRACTION_UPGRADE_MODULE_3 = registerItem("xp_extraction_upgrade_module_3",
            props -> new XPExtractionUpgradeModuleItem(props, 3));
    public static final Item XP_EXTRACTION_UPGRADE_MODULE_4 = registerItem("xp_extraction_upgrade_module_4",
            props -> new XPExtractionUpgradeModuleItem(props, 4));
    public static final Item XP_EXTRACTION_UPGRADE_MODULE_5 = registerItem("xp_extraction_upgrade_module_5",
            props -> new XPExtractionUpgradeModuleItem(props, 5));
    public static final Item XP_EXTRACTION_UPGRADE_MODULE_6 = registerItem("xp_extraction_upgrade_module_6",
            props -> new XPExtractionUpgradeModuleItem(props, 6));
    public static final Item XP_EXTRACTION_UPGRADE_MODULE_7 = registerItem("xp_extraction_upgrade_module_7",
            props -> new XPExtractionUpgradeModuleItem(props, 7));
    public static final Item XP_EXTRACTION_UPGRADE_MODULE_8 = registerItem("xp_extraction_upgrade_module_8",
    ...
    public static final Item BATTERY_9 = registerItem("battery_9",
            props -> new BatteryItem(BatteryTier.BATTERY_9));
    public static final Item BATTERY_10 = registerItem("battery_10",
    ...
    public static final Item STONE_HAMMER = registerItem("stone_hammer",
            props -> new HammerItem(Tiers.STONE, new Item.Properties()));
    public static final Item IRON_HAMMER = registerItem("iron_hammer",
            props -> new HammerItem(Tiers.IRON, new Item.Properties()));
    public static final Item GOLDEN_HAMMER = registerItem("golden_hammer",
            props -> new HammerItem(Tiers.GOLD, new Item.Properties()));
    public static final Item DIAMOND_HAMMER = registerItem("diamond_hammer",
            props -> new HammerItem(Tiers.DIAMOND, new Item.Properties()));
