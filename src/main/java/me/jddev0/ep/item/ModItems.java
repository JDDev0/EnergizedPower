...
public final class ModItems {
    ...
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_1 = registerItem("extraction_depth_upgrade_module_1",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(ModCreativeModeTab.ENERGIZED_POWER_TAB), 1));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_2 = registerItem("extraction_depth_upgrade_module_2",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(ModCreativeModeTab.ENERGIZED_POWER_TAB), 2));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_3 = registerItem("extraction_depth_upgrade_module_3",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(ModCreativeModeTab.ENERGIZED_POWER_TAB), 3));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_4 = registerItem("extraction_depth_upgrade_module_4",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(ModCreativeModeTab.ENERGIZED_POWER_TAB), 4));
    public static final Item EXTRACTION_DEPTH_UPGRADE_MODULE_5 = registerItem("extraction_depth_upgrade_module_5",
            new ExtractionDepthUpgradeModuleItem(new FabricItemSettings().group(ModCreativeModeTab.ENERGIZED_POWER_TAB), 5));
    ...
    public static final Item CHARCOAL_FILTER = registerItem("charcoal_filter",
            new Item(new FabricItemSettings().group(ModCreativeModeTab.ENERGIZED_POWER_TAB).maxDamage(200).maxDamageIfAbsent(200)));
    ...
    public static final Item INVENTORY_TELEPORTER = registerItem("inventory_teleporter",
            new InventoryTeleporterItem(new FabricItemSettings().group(ModCreativeModeTab.ENERGIZED_POWER_TAB).maxCount(1)));
