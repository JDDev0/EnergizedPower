...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    private void registerSpecialModels() {
        ...
        withExistingParent(inventoryCoalEngineItemId.getPath(), "generated").
                ...
                override().
                predicate(new ResourceLocation(EnergizedPowerMod.MODID, "active"), 1.f).
                model(inventoryCoalEngineActive).
                end().
                override().
                predicate(new ResourceLocation(EnergizedPowerMod.MODID, "active"), 1.f).
                predicate(new ResourceLocation(EnergizedPowerMod.MODID, "working"), 1.f).
    ...
    private ItemModelBuilder basicItem(Holder<Item> item, String pathPostfix) {
        ResourceLocation itemID = Objects.requireNonNull(item.unwrapKey().orElseThrow()).location();
