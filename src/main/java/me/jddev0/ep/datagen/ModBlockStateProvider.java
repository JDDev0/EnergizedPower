...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private ModelFile orientableWithBackBlockModel(RegistryObject<? extends Block> block, String fileSuffix, String topSuffix,
    ...
    private ModelFile orientableVerticalWithBackBlockModel(RegistryObject<? extends Block> block, String fileSuffix, String topSuffix,
                                                   String bottomSuffix, String frontSuffix, String backSuffix, String sideSuffix) {
        ResourceLocation blockId = block.getId();
    ...
    private ModelFile orientableVerticalBlockModel(RegistryObject<? extends Block> block, String fileSuffix, String topSuffix,
                                           String bottomSuffix, String frontSuffix, String sideSuffix) {
        ResourceLocation blockId = block.getId();
    ...
    private void activatableBlockWithItem(RegistryObject<? extends Block> block, ModelFile modelNormal,
    ...
    private void fluidPipeBlockWithItem(RegistryObject<? extends Block> block) {
        ...
        itemModels().
                ...
                transforms().
                transform(ItemTransforms.TransformType.GUI).rotation(30, 45, 0).end().
                transform(ItemTransforms.TransformType.GROUND).scale(.65f, .65f, .65f).end().
                transform(ItemTransforms.TransformType.FIXED).scale(.65f, .65f, .65f).end().
                transform(ItemTransforms.TransformType.FIRST_PERSON_RIGHT_HAND).scale(.65f, .65f, .65f).end().
                transform(ItemTransforms.TransformType.FIRST_PERSON_LEFT_HAND).scale(.65f, .65f, .65f).end().
                transform(ItemTransforms.TransformType.THIRD_PERSON_RIGHT_HAND).scale(.65f, .65f, .65f).end().
                transform(ItemTransforms.TransformType.THIRD_PERSON_LEFT_HAND).scale(.65f, .65f, .65f).end().end();
    }
    ...
    private void cableBlockWithItem(RegistryObject<? extends Block> block) {
        ...
        itemModels().
                ...
                transforms().
                transform(ItemTransforms.TransformType.GUI).rotation(30, 45, 0).scale(1.5f, 1.5f, 1.5f).end().
                transform(ItemTransforms.TransformType.GROUND).scale(1.01f, 1.01f, 1.01f).end().
                transform(ItemTransforms.TransformType.FIXED).scale(1.01f, 1.01f, 1.01f).end().
                transform(ItemTransforms.TransformType.FIRST_PERSON_RIGHT_HAND).scale(1.01f, 1.01f, 1.01f).end().
                transform(ItemTransforms.TransformType.FIRST_PERSON_LEFT_HAND).scale(1.01f, 1.01f, 1.01f).end().
                transform(ItemTransforms.TransformType.THIRD_PERSON_RIGHT_HAND).scale(1.01f, 1.01f, 1.01f).end().
                transform(ItemTransforms.TransformType.THIRD_PERSON_LEFT_HAND).scale(1.01f, 1.01f, 1.01f).end().end();
    }
    ...
    private void transformerBlockWithItem(RegistryObject<? extends TransformerBlock> block) {
        ...
        switch(transformerType) {
            case TYPE_1_TO_N, TYPE_N_TO_1 -> {
                ...
                simpleBlockItem(block.get(), transformer);
            }
            case TYPE_3_TO_3 -> {
                ModelFile transformer = models().
                        withExistingParent(blockId.getPath(), ModelProvider.BLOCK_FOLDER + "/cube").
    ...
    private void poweredLampBlockWithItem(RegistryObject<? extends Block> block) {
        ...
        VariantBlockStateBuilder blockStateBuilder = getVariantBuilder(block.get()).partialState().
