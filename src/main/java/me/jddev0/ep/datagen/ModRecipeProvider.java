...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void buildUpgradeModuleCraftingRecipes(Consumer<FinishedRecipe> output) {
        ...
        addShapedCraftingRecipe(output, has(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_1), Map.of(
                ...
                'B', Ingredient.of(EPItems.BASIC_UPGRADE_MODULE.get()),
                'F', Ingredient.of(EPBlocks.IRON_FLUID_PIPE_ITEM.get()),
                'E', Ingredient.of(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_1.get())
        ), new String[] {
                "IRI",
                "FBF",
                "IEI"
        ...
        addShapedCraftingRecipe(output, has(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_2), Map.of(
                ...
                'A', Ingredient.of(EPItems.ADVANCED_UPGRADE_MODULE.get()),
                'F', Ingredient.of(EPBlocks.IRON_FLUID_PIPE_ITEM.get()),
                'E', Ingredient.of(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_2.get())
        ), new String[] {
                "IRI",
                "FAF",
                "IEI"
        ...
        addShapedCraftingRecipe(output, has(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_3), Map.of(
                ...
                'A', Ingredient.of(EPItems.ADVANCED_UPGRADE_MODULE.get()),
                'F', Ingredient.of(EPBlocks.IRON_FLUID_PIPE_ITEM.get()),
                'E', Ingredient.of(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_3.get())
        ), new String[] {
                "IRI",
                "FAF",
                "IEI"
        ...
        addShapedCraftingRecipe(output, has(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_4), Map.of(
                ...
                'R', Ingredient.of(EPItems.REINFORCED_ADVANCED_UPGRADE_MODULE.get()),
                'F', Ingredient.of(EPBlocks.IRON_FLUID_PIPE_ITEM.get()),
                'E', Ingredient.of(EPItems.EXTRACTION_RANGE_UPGRADE_MODULE_4.get())
        ), new String[] {
                "IrI",
                "FRF",
                "IEI"
    ...
    private void buildItemTransportCraftingRecipes(Consumer<FinishedRecipe> output) {
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.INGOTS_STEEL), Map.of(
                ...
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'B', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_ITEM.get())
        ), new String[] {
                "RIR",
                "SBS",
                "RIR"
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.GEARS_IRON), Map.of(
                ...
                'R', Ingredient.of(CommonItemTags.RODS_IRON),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM.get())
        ), new String[] {
                "GRG",
                "rFr",
                "GRG"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'c', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_ITEM.get()),
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM.get()),
                'B', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER.get())
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                's', Ingredient.of(CommonItemTags.INGOTS_STEEL),
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM.get()),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_LOADER_ITEM.get())
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM), Map.of(
                ...
                'L', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM.get())
        ), new String[] {
                "CRC",
                "ILI",
                "CRC"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM.get()),
                'B', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_SORTER_ITEM.get())
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM.get()),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_SORTER_ITEM.get())
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM.get()),
                'B', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_SWITCH_ITEM.get())
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM.get()),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_SWITCH_ITEM.get())
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM.get()),
                'B', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_SPLITTER_ITEM.get())
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM.get()),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_SPLITTER_ITEM.get())
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM.get()),
                'B', Ingredient.of(EPBlocks.BASIC_ITEM_CONVEYOR_BELT_MERGER_ITEM.get())
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EPBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM.get()),
                'F', Ingredient.of(EPBlocks.FAST_ITEM_CONVEYOR_BELT_MERGER_ITEM.get())
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.ITEM_SILO_TINY_ITEM), Map.of(
                'S', Ingredient.of(EPBlocks.ITEM_SILO_TINY_ITEM.get()),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'i', Ingredient.of(CommonItemTags.PLATES_IRON)
        ), new String[] {
                "IiI",
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.ITEM_SILO_SMALL_ITEM), Map.of(
                'S', Ingredient.of(EPBlocks.ITEM_SILO_SMALL_ITEM.get()),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'i', Ingredient.of(CommonItemTags.PLATES_IRON),
                's', Ingredient.of(CommonItemTags.INGOTS_STEEL)
        ), new String[] {
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.ITEM_SILO_MEDIUM_ITEM), Map.of(
                'S', Ingredient.of(EPBlocks.ITEM_SILO_MEDIUM_ITEM.get()),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                's', Ingredient.of(CommonItemTags.INGOTS_STEEL)
        ), new String[] {
                "IsI",
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.ITEM_SILO_LARGE_ITEM), Map.of(
                'S', Ingredient.of(EPBlocks.ITEM_SILO_LARGE_ITEM.get()),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON)
        ), new String[] {
                "III",
                "ISI",
    ...
    private void buildMachineCraftingRecipes(Consumer<FinishedRecipe> output) {
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'a', Ingredient.of(CommonItemTags.PLATES_ADVANCED_ALLOY),
                'A', Ingredient.of(EPBlocks.ADVANCED_MACHINE_FRAME_ITEM.get()),
                'F', Ingredient.of(EPBlocks.FLUID_PUMP_ITEM.get()),
                'f', Ingredient.of(EPBlocks.FLUID_TANK_LARGE_ITEM.get())
        ), new String[] {
                "GFG",
                "fAf",
                "aFa"
    ...
    private void buildPulverizerRecipes(Consumer<FinishedRecipe> output) {
        ...
        addPulverizerRecipe(output, Ingredient.of(Tags.Items.GRAVEL),
    ...
    private void buildStoneLiquefierRecipes(Consumer<FinishedRecipe> output) {
    ...
    private void addLavaOutputStoneLiquefierRecipe(Consumer<FinishedRecipe> recipeOutput, Ingredient input, int lavaAmount, String recipeIngredientName) {
        addStoneLiquefierRecipe(recipeOutput, input, new FluidStack(Fluids.LAVA, lavaAmount), recipeIngredientName);
    }
    private void addWaterOutputStoneLiquefierRecipe(Consumer<FinishedRecipe> recipeOutput, Ingredient input, int waterAmount, String recipeIngredientName) {
        addStoneLiquefierRecipe(recipeOutput, input, new FluidStack(Fluids.WATER, waterAmount), recipeIngredientName);
    }
    private void addStoneLiquefierRecipe(Consumer<FinishedRecipe> recipeOutput, Ingredient input, FluidStack output, String recipeIngredientName) {
