...
public final class ModTexturedModel {
    ...
    public static TextureMapping itemConveyorBelt(Block block) {
        return new TextureMapping().
                ...
                put(ModTextureKey.BELT, TextureMapping.getBlockTexture(block));
    }
    ...
    public static TextureMapping fluidPipeCore(Block block) {
        return new TextureMapping().
                ...
                put(ModTextureKey.FLUID_PIPE_CORE, TextureMapping.getBlockTexture(block, "_core"));
    }
    ...
    public static TextureMapping fluidPipeSideConnected(Block block) {
        return new TextureMapping().
                ...
                put(ModTextureKey.FLUID_PIPE_SIDE, TextureMapping.getBlockTexture(block, "_side_connected"));
    }
    ...
    public static TextureMapping fluidPipeSideExtracted(Block block) {
        return new TextureMapping().
                ...
                put(ModTextureKey.FLUID_PIPE_SIDE_INNER, TextureMapping.getBlockTexture(block, "_side_inner_extract")).
                put(ModTextureKey.FLUID_PIPE_SIDE_OUTER, TextureMapping.getBlockTexture(block, "_side_outer_extract"));
    }
    ...
    public static TextureMapping fluidTank(Block block) {
        return new TextureMapping().
                ...
                put(ModTextureKey.INTERIOR, TextureMapping.getBlockTexture(block, "_interior")).
    ...
    public static TextureMapping cableCore(Block block) {
        return new TextureMapping().
                put(TextureSlot.PARTICLE, TextureMapping.getBlockTexture(block)).
                put(ModTextureKey.CABLE, TextureMapping.getBlockTexture(block));
    }
