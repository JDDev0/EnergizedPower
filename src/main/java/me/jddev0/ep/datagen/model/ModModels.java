...
public final class ModModels {
    ...
    private static Model block(String parent, TextureKey ... requiredTextureKeys) {
        return new Model(Optional.of(new Identifier(EnergizedPowerMod.MODID, "block/" + parent)), Optional.empty(), requiredTextureKeys);
    }

    private static Model block(String parent, String variant, TextureKey... requiredTextureKeys) {
        return new Model(Optional.of(new Identifier(EnergizedPowerMod.MODID, "block/" + parent)), Optional.of(variant), requiredTextureKeys);
    }
}
