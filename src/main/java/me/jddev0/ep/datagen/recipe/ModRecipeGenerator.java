...
public class ModRecipeGenerator extends FabricRecipeProvider {
    ...
    private void buildToolsCraftingRecipes() {
        ...
        addHammerCraftingRecipe(ConventionalItemTags.IRON_INGOTS, EPItems.IRON_HAMMER);
        addHammerCraftingRecipe(ConventionalItemTags.GOLD_INGOTS, EPItems.GOLDEN_HAMMER);
        addHammerCraftingRecipe(ConventionalItemTags.DIAMOND_GEMS, EPItems.DIAMOND_HAMMER);
    ...
    private void buildCompressorRecipes() {
        ...
        addPlateCompressorRecipes(Ingredient.of(CommonItemTags.INGOTS_TIN),
                ...
                "tin");
        addPlateCompressorRecipes(Ingredient.of(ConventionalItemTags.COPPER_INGOTS),
                Ingredient.of(ConventionalItemTags.STORAGE_BLOCKS_COPPER), new ItemStack(EPItems.COPPER_PLATE),
                "copper");
        addPlateCompressorRecipes(Ingredient.of(ConventionalItemTags.IRON_INGOTS),
                Ingredient.of(ConventionalItemTags.STORAGE_BLOCKS_IRON), new ItemStack(EPItems.IRON_PLATE),
                "iron");
        addPlateCompressorRecipes(Ingredient.of(ConventionalItemTags.GOLD_INGOTS),
    ...
    private void buildCrusherRecipes() {
        ...
        addCrusherRecipe(Ingredient.of(CommonItemTags.COBBLESTONES_NORMAL), new ItemStack(Items.GRAVEL),
                "cobblestone");

        addCrusherRecipe(Ingredient.of(CommonItemTags.GRAVELS), new ItemStack(Items.SAND),
                "gravel");
    ...
    private void buildPulverizerRecipes() {
        ...
        addPulverizerRecipe(Ingredient.of(CommonItemTags.ORES_COPPER),
        ...
        addPulverizerRecipe(Ingredient.of(CommonItemTags.ORES_COAL),
        ...
        addPulverizerRecipe(Ingredient.of(CommonItemTags.ORES_REDSTONE),
        ...
        addPulverizerRecipe(Ingredient.of(CommonItemTags.ORES_LAPIS),
        ...
        addPulverizerRecipe(Ingredient.of(CommonItemTags.ORES_EMERALD),
        ...
        addPulverizerRecipe(Ingredient.of(CommonItemTags.ORES_DIAMOND),
        ...
        addPulverizerRecipe(Ingredient.of(ConventionalItemTags.QUARTZ_ORES),
        ...
        addPulverizerRecipe(Ingredient.of(ConventionalItemTags.NETHERITE_SCRAP_ORES),
        ...
        addPulverizerRecipe(Ingredient.of(ConventionalItemTags.GRAVELS),
                new PulverizerRecipe.OutputItemStackWithPercentages(new ItemStack(Items.FLINT),
                        1., 1.), "gravels");

        addPulverizerRecipe(Ingredient.of(ConventionalItemTags.BONES),
        ...
        addPulverizerRecipe(Ingredient.of(ConventionalItemTags.BLAZE_RODS),
        ...
        addPulverizerRecipe(Ingredient.of(ConventionalItemTags.BREEZE_RODS),
    ...
    private void buildSawmillRecipes() {
        ...
        addSawmillRecipe(Ingredient.of(ConventionalItemTags.WOODEN_RODS), new ItemStack(EPItems.SAWDUST),
                0, "sawdust", "sticks");
    }
    ...
    private void buildMetalPressRecipes() {
        addGearMetalPressRecipe(Ingredient.of(CommonItemTags.PLATES_IRON), new ItemStack(EPItems.IRON_GEAR));

        addRodMetalPressRecipe(Ingredient.of(CommonItemTags.PLATES_IRON), new ItemStack(EPItems.IRON_ROD));

        addWireMetalPressRecipe(Ingredient.of(CommonItemTags.PLATES_TIN), new ItemStack(EPItems.TIN_WIRE));
        addWireMetalPressRecipe(Ingredient.of(CommonItemTags.PLATES_COPPER), new ItemStack(EPItems.COPPER_WIRE));
        addWireMetalPressRecipe(Ingredient.of(CommonItemTags.PLATES_GOLD), new ItemStack(EPItems.GOLD_WIRE));

        addWireMetalPressRecipe(Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER), new ItemStack(EPItems.ENERGIZED_COPPER_WIRE));
        addWireMetalPressRecipe(Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD), new ItemStack(EPItems.ENERGIZED_GOLD_WIRE));
    }
    ...
    private void buildChargerRecipes() {
        addChargerRecipe(Ingredient.of(ConventionalItemTags.COPPER_INGOTS),
                new ItemStack(EPItems.ENERGIZED_COPPER_INGOT), 4194304);
    }

    private void buildEnergizerRecipes() {
        addEnergizerRecipe(Ingredient.of(ConventionalItemTags.COPPER_INGOTS),
                new ItemStack(EPItems.ENERGIZED_COPPER_INGOT), 32768);
        addEnergizerRecipe(Ingredient.of(ConventionalItemTags.GOLD_INGOTS),
    ...
    private void buildCrystalGrowthChamberRecipes() {
        addCrystalGrowthChamberRecipe(Ingredient.of(ConventionalItemTags.AMETHYST_GEMS),
    ...
    private void addWaterInputFluidFreezerRecipe(long waterAmount, ItemStack output) {
