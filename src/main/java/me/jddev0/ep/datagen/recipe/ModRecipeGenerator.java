...
public class ModRecipeGenerator extends RecipeProvider implements IConditionBuilder {
    ...
    private void addPressMoldUpgradeRecipe(ItemLike pressMoldPreviousTier, Ingredient plate, Ingredient ingot, ItemStack pressMoldItem) {
    ...
    private ItemStack itemStackOf(Supplier<Item> item) {
        return new ItemStack(item.get());
    }

    private ItemStack itemStackOf(Supplier<Item> item, int count) {
