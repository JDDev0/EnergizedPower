...
public class ModRecipeGenerator extends RecipeProvider {
    ...
    private void buildItemIngredientsCraftingRecipes() {
        ...
        addShapedCraftingRecipe(output, has(EPItems.QUANTUM_PROCESSING_UNIT), Map.of(
    ...
    private void buildUpgradeModuleCraftingRecipes() {
        ...
        addEliteUpgradeModuleRecipe(output, EPItems.SPEED_UPGRADE_MODULE_6,
                new ItemStackTemplate(EPItems.SPEED_UPGRADE_MODULE_7));
        addEliteUpgradeModuleRecipe(output, EPItems.SPEED_UPGRADE_MODULE_7,
        ...
        addEliteUpgradeModuleRecipe(output, EPItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_6,
                new ItemStackTemplate(EPItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_7));
        addEliteUpgradeModuleRecipe(output, EPItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_7,
        ...
        addEliteUpgradeModuleRecipe(output, EPItems.ENERGY_PRODUCTION_UPGRADE_MODULE_6,
                new ItemStackTemplate(EPItems.ENERGY_PRODUCTION_UPGRADE_MODULE_7));
        addEliteUpgradeModuleRecipe(output, EPItems.ENERGY_PRODUCTION_UPGRADE_MODULE_7,
        ...
        addEliteUpgradeModuleRecipe(output, EPItems.ENERGY_CAPACITY_UPGRADE_MODULE_6,
                new ItemStackTemplate(EPItems.ENERGY_CAPACITY_UPGRADE_MODULE_7));
        addEliteUpgradeModuleRecipe(output, EPItems.ENERGY_CAPACITY_UPGRADE_MODULE_7,
        ...
        addShapedCraftingRecipe(output, has(EPItems.MOON_LIGHT_UPGRADE_MODULE_3), Map.of(
                'E', ingredientOf(CommonItemTags.PLATES_ENERGIZED_ALLOY),
        ...
        addShapedCraftingRecipe(output, has(EPItems.MOON_LIGHT_UPGRADE_MODULE_4), Map.of(
                'E', ingredientOf(CommonItemTags.PLATES_ENERGIZED_ALLOY),
                'C', ingredientOf(CommonItemTags.GEMS_CRYSTALLIZED_LAPIS_LAZULI),
                'e', ingredientOf(EPItems.ELITE_SOLAR_CELL),
                'U', ingredientOf(EPItems.ELITE_UPGRADE_MODULE),
    ...
    private void buildMachineCraftingRecipes() {
        ...
        addShapedCraftingRecipe(output, has(EPBlocks.SOLAR_PANEL_ITEM_6), Map.of(
                'G', ingredientOf(Tags.Items.GLASS_PANES_COLORLESS),
                'C', ingredientOf(CommonItemTags.GEMS_CRYSTALLIZED_LAPIS_LAZULI),
    ...
    private void buildCompressorRecipes() {
        ...
        addPlateCompressorIngotRecipe(output, ingredientOf(CommonItemTags.INGOTS_CRYSTALLIZED_ALLOY),
    ...
    private void buildSawmillRecipes() {
        ...
        addSawmillRecipe(output, ingredientOf(Items.SMITHING_TABLE), new ItemStackTemplate(Items.OAK_PLANKS, 4),
        ...
        addSawmillRecipe(output, ingredientOf(Items.WOODEN_SPEAR), new ItemStackTemplate(Items.OAK_PLANKS),
        ...
        addSawmillRecipe(output, ingredientOf(Items.SHIELD), new ItemStackTemplate(Items.OAK_PLANKS, 6),
        ...
        addSawmillRecipe(output, ingredientOf(Items.PAINTING), new ItemStackTemplate(Items.STICK, 8),
                new ItemStackTemplate(Items.WHITE_WOOL), "sticks", "painting");
        addSawmillRecipe(output, ingredientOf(Items.ITEM_FRAME), new ItemStackTemplate(Items.STICK, 8),
    ...
    private void buildFluidFreezerRecipe() {
        addWaterInputFluidFreezerRecipe(output, 125, new ItemStackTemplate(Items.SNOWBALL));

        addWaterInputFluidFreezerRecipe(output, 500, new ItemStackTemplate(Items.SNOW_BLOCK));

        addWaterInputFluidFreezerRecipe(output, 1000, new ItemStackTemplate(Items.ICE));
    }
    ...
    private void addEliteUpgradeModuleRecipe(RecipeOutput output, ItemLike upgradeModulePreviousTier, ItemStackTemplate upgradeModuleItem) {
        addShapedCraftingRecipe(output, has(upgradeModulePreviousTier), Map.of(
                'E', ingredientOf(CommonItemTags.PLATES_ENERGIZED_ALLOY),
                'C', ingredientOf(CommonItemTags.GEMS_CRYSTALLIZED_LAPIS_LAZULI),
    ...
    private void addWaterInputFluidFreezerRecipe(RecipeOutput recipeOutput, int waterAmount, ItemStackTemplate output) {
        addFluidFreezerRecipe(recipeOutput, new FluidStackTemplate(Fluids.WATER, waterAmount), output);
    }
    private void addFluidFreezerRecipe(RecipeOutput recipeOutput, FluidStackTemplate input, ItemStackTemplate output) {
