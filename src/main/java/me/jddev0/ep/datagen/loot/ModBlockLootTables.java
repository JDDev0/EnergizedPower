...
public class ModBlockLootTables extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        dropSelf(EPBlocks.TURBO_ITEM_CONVEYOR_BELT);
        ...
        dropSelf(EPBlocks.TURBO_ITEM_CONVEYOR_BELT_LOADER);
        ...
        dropSelf(EPBlocks.TURBO_ITEM_CONVEYOR_BELT_SORTER);
        ...
        dropSelf(EPBlocks.TURBO_ITEM_CONVEYOR_BELT_SWITCH);
        ...
        dropSelf(EPBlocks.TURBO_ITEM_CONVEYOR_BELT_SPLITTER);
        ...
        dropSelf(EPBlocks.TURBO_ITEM_CONVEYOR_BELT_MERGER);
        ...
        dropSelf(EPBlocks.FLUID_FREEZER);
        ...
        dropSelf(EPBlocks.ELITE_MINECART_CHARGER);
