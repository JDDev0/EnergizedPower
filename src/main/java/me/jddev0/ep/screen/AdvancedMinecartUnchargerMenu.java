...
public class AdvancedMinecartUnchargerMenu extends AbstractContainerMenu implements EnergyStorageMenu {
    ...
    public AdvancedMinecartUnchargerMenu(int id, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.ADVANCED_MINECART_UNCHARGER_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.ADVANCED_MINECART_UNCHARGER.get());
    }
