...
public class CrusherScreen extends ConfigurableIOUpgradableEnergyStorageContainerScreen<CrusherMenu> {
    public CrusherScreen(CrusherMenu menu, Inventory inventory, Component component) {
        super(menu, inventory, component,
                "tooltip.energizedpower.recipe.energy_required_to_finish.txt",
                EPAPI.id("textures/gui/container/crusher.png"),
    ...
    private void renderProgressArrow(GuiGraphics drawContext, int x, int y) {
        if(menu.isCraftingActive())
            drawContext.blit(MACHINE_SPRITES_TEXTURE, x + 80, y + 34, 0, 58, menu.getScaledProgressArrowSize(), 17);
    }
}
