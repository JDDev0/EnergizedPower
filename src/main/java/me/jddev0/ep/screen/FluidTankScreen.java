...
public class FluidTankScreen extends HandledScreen<FluidTankMenu> {
    ...
    protected void drawBackground(MatrixStack poseStack, float partialTick, int mouseX, int mouseY) {
        ...
        for(int i = 0;i < 2;i++) {
            renderFluidMeterContent(poseStack, x, y, i);
    ...
    private void renderFluidMeterContent(MatrixStack poseStack, int x, int y, int tank) {
        ...
        if(tank == 0)
            ...
            poseStack.translate(x + 152, y + 19, 0);

        renderFluidStack(poseStack, tank);
    ...
    private void renderFluidStack(MatrixStack poseStack, int tank) {
