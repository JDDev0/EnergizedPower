...
public class FluidDrainerMenu extends UpgradableEnergyStorageMenu<FluidDrainerBlockEntity>
    ...
    public FluidDrainerMenu(int id, Inventory inv, BlockPos pos) {
    ...
    public FluidDrainerMenu(int id, BlockEntity blockEntity, Inventory playerInventory, Container inv,
