...
public class EliteAutoCrafterScreen
        extends ConfigurableIOUpgradableEnergyStorageContainerScreen<EliteAutoCrafterMenu> {

    public EliteAutoCrafterScreen(EliteAutoCrafterMenu menu, Inventory inventory, Component component) {
        super(menu, inventory, component,
                "tooltip.energizedpower.recipe.energy_required_to_finish.txt",
                EPAPI.id("textures/gui/container/elite_auto_crafter.png"),
                EPAPI.id("textures/gui/container/upgrade_view/elite_auto_crafter.png"));

        imageHeight = 242;
        inventoryLabelY = imageHeight - 94;
        ioConfigurationViewY = 159;
    }
    ...
    private void renderCheckboxes(GuiGraphics guiGraphics, int x, int y, int mouseX, int mouseY) {
        ...
        if(menu.isAllowOutputOverflow()) {
            ...
            guiGraphics.blit(MACHINE_SPRITES_TEXTURE, x + 158, y + 59, 0, 139, 11, 11, 256, 256);
        }
