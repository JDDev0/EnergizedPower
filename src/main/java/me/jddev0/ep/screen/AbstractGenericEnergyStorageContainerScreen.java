...
public abstract class AbstractGenericEnergyStorageContainerScreen<T extends AbstractContainerMenu & EnergyStorageMenu> extends AbstractContainerScreen<T> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(EnergizedPowerMod.MODID, "textures/gui/container/generic_energy.png");

    public AbstractGenericEnergyStorageContainerScreen(T menu, Inventory inventory, Component component) {
    ...
    private void renderEnergyMeter(PoseStack poseStack, int x, int y) {
        int pos = menu.getScaledEnergyMeterPos(52);
