...
public class AdvancedCrusherScreen extends ConfigurableIOUpgradableEnergyStorageContainerScreen<AdvancedCrusherMenu> {
    ...
    private void renderProgressArrow(GuiGraphics drawContext, int x, int y) {
        if(menu.isCraftingActive())
            drawContext.blit(MACHINE_SPRITES_TEXTURE, x + 90, y + 34, 0, 58, menu.getScaledProgressArrowSize(), 17);
    }
