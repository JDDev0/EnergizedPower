...
public class MinecartUnchargerMenu extends AbstractContainerMenu implements EnergyStorageMenu, EnergyStorageMenuPacketUpdate {
    ...
    public MinecartUnchargerMenu(int id, Inventory inv, BlockEntity blockEntity, ContainerData data) {
