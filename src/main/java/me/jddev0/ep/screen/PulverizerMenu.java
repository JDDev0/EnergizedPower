...
public class PulverizerMenu extends ScreenHandler implements EnergyStorageConsumerIndicatorBarMenu {
    ...
    public PulverizerMenu(int id, BlockEntity blockEntity, PlayerInventory playerInventory, Inventory inv, PropertyDelegate data) {
        super(ModMenuTypes.PULVERIZER_MENU, id);
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(ScreenHandlerContext.create(level, blockEntity.getPos()), player, ModBlocks.PULVERIZER);
    }
