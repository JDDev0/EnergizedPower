...
public class StoneSolidifierScreen extends AbstractGenericEnergyStorageHandledScreen<StoneSolidifierMenu> {
    ...
    protected void drawBackground(DrawContext drawContext, float partialTick, int mouseX, int mouseY) {
        ...
        renderCurrentRecipeOuput(drawContext, x, y);
    ...
    private void renderCurrentRecipeOuput(DrawContext drawContext, int x, int y) {
        RecipeEntry<StoneSolidifierRecipe> currentRecipe = handler.getCurrentRecipe();
