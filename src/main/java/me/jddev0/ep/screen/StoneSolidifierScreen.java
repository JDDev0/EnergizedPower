...
public class StoneSolidifierScreen extends AbstractGenericEnergyStorageHandledScreen<StoneSolidifierMenu> {
    ...
    private void renderCurrentRecipeOuput(MatrixStack poseStack, int x, int y) {
        ...
        if(!output.isEmpty()) {
            ...
            itemRenderer.renderInGuiWithOverrides(poseStack, output, x + 98, y + 17, 98 + 17 * this.backgroundWidth);
