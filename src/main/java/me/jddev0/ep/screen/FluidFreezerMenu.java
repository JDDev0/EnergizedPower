...
public class FluidFreezerMenu extends ConfigurableIOUpgradableEnergyStorageMenu<FluidFreezerBlockEntity>
    ...
    public FluidFreezerMenu(int id, Inventory inv, BlockEntity blockEntity, UpgradeModuleInventory upgradeModuleInventory,
        ...
        ItemCapabilityMenuHelper.getCapabilityItemHandler(this.level, this.blockEntity).ifPresent(itemHandler -> {
            addSlot(new SlotItemHandler(itemHandler, 0, 134, 44) {
                @Override
