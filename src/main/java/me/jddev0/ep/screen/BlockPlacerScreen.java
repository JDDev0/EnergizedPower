...
public class BlockPlacerScreen extends HandledScreen<BlockPlacerMenu> {
    private static final Identifier TEXTURE = new Identifier(EnergizedPowerMod.MODID, "textures/gui/container/block_placer.png");
    ...
    protected void drawMouseoverTooltip(MatrixStack poseStack, int mouseX, int mouseY) {
        ...
        if(isPointWithinBounds(8, 17, 16, 52, mouseX, mouseY)) {
            ...
            if(handler.getEnergyRequirement() > 0) {
                components.add(new TranslatableText("tooltip.energizedpower.block_placer.block_energy_left.txt",
