...
public class BlockPlacerScreen extends AbstractContainerScreen<BlockPlacerMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(EnergizedPowerMod.MODID, "textures/gui/container/block_placer.png");
    ...
    protected void renderTooltip(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        if(isHovering(8, 17, 16, 52, mouseX, mouseY)) {
            ...
            if(menu.getEnergyRequirement() > 0) {
                components.add(new TranslatableComponent("tooltip.energizedpower.block_placer.block_energy_left.txt",
