...
public class CoalEngineScreen
        extends ConfigurableIOUpgradableEnergyStorageContainerScreen<CoalEngineMenu> {
    public CoalEngineScreen(CoalEngineMenu menu, Inventory inventory, Component component) {
        super(menu, inventory, component,
                ...
                EPAPI.id("textures/gui/container/upgrade_view/1_energy_capacity_1_energy_production_1_item_ejector_1_item_pulling.png"));
    ...
    private void renderProgressFlame(GuiGraphicsExtractor drawContext, int x, int y) {
        if(menu.isProducingActive()) {
            ...
            drawContext.blit(RenderPipelines.GUI_TEXTURED, MACHINE_SPRITES_TEXTURE, x + 81, y + 28 + pos, 0, 121 + pos, 14, 14 - pos, 256, 256);
        }
    }
}
