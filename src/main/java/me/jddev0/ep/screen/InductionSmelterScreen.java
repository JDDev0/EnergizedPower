...
public class InductionSmelterScreen
        extends ConfigurableIOUpgradableEnergyStorageContainerScreen<InductionSmelterMenu> {
    ...
    private void renderProgressArrow(GuiGraphicsExtractor guiGraphics, int x, int y) {
        if(menu.isCraftingActive())
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, MACHINE_SPRITES_TEXTURE, x + 104, y + 34, 0, 58, menu.getScaledProgressArrowSize(), 17, 256, 256);
    }
}
