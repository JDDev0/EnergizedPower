...
public class AssemblingMachineMenu extends AbstractContainerMenu implements EnergyStorageConsumerIndicatorBarMenu {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.ASSEMBLING_MACHINE.get());
    }
