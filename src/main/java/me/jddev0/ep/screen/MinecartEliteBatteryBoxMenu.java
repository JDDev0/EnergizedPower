...
public class MinecartEliteBatteryBoxMenu extends AbstractContainerMenu implements IEnergyStorageMenu {
    ...
    public MinecartEliteBatteryBoxMenu(int id, Inventory inv) {
        this(id, inv, new SimpleContainer(0), null);
    }

    public MinecartEliteBatteryBoxMenu(int id, Inventory inv, Container container, ContainerData data) {
        super(EPMenuTypes.MINECART_ELITE_BATTERY_BOX_MENU.get(), id);
