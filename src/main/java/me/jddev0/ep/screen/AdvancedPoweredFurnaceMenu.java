...
public class AdvancedPoweredFurnaceMenu extends ConfigurableIOUpgradableEnergyStorageMenu<AdvancedPoweredFurnaceBlockEntity>
    ...
    public AdvancedPoweredFurnaceMenu(int id, Inventory inv, BlockEntity blockEntity, UpgradeModuleInventory upgradeModuleInventory,
        ...
        ItemCapabilityMenuHelper.getEnergizedPowerItemStackHandlerCapability(this.level, this.blockEntity).ifPresent(itemHandler -> {
            ...
            addSlot(new ResourceHandlerSlot(itemHandler, itemHandler::set, 1, 80, 17) {
                @Override
                public boolean isActive() {
                    return super.isActive() && !isInUpgradeModuleView();
                }
            });
            addSlot(new ResourceHandlerSlot(itemHandler, itemHandler::set, 2, 116, 17) {
                @Override
                public boolean isActive() {
                    return super.isActive() && !isInUpgradeModuleView();
                }
            ...
            addSlot(new ResourceHandlerSlot(itemHandler, itemHandler::set, 4, 80, 53) {
                @Override
                public boolean isActive() {
                    return super.isActive() && !isInUpgradeModuleView();
                }
            });
            addSlot(new ResourceHandlerSlot(itemHandler, itemHandler::set, 5, 116, 53) {
                @Override
                public boolean isActive() {
                    return super.isActive() && !isInUpgradeModuleView();
                }
