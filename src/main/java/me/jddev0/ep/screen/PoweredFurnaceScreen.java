...
public class PoweredFurnaceScreen extends HandledScreen<PoweredFurnaceMenu> {
    private static final Identifier TEXTURE = new Identifier(EnergizedPowerMod.MODID, "textures/gui/container/powered_furnace.png");

    public PoweredFurnaceScreen(PoweredFurnaceMenu menu, PlayerInventory inventory, Text component) {
    ...
    private void renderProgressArrow(MatrixStack poseStack, int x, int y) {
        if(handler.isCraftingActive())
            drawTexture(poseStack, x + 80, y + 34, 176, 52, handler.getScaledProgressArrowSize(), 17);
    }
