...
public class SawmillScreen extends HandledScreen<SawmillMenu> {
    private static final Identifier TEXTURE = new Identifier(EnergizedPowerMod.MODID, "textures/gui/container/sawmill.png");
    ...
    private void renderProgressArrow(MatrixStack poseStack, int x, int y) {
        if(handler.isCraftingActive())
            drawTexture(poseStack, x + 68, y + 34, 176, 52, handler.getScaledProgressArrowSize(), 17);
    }
