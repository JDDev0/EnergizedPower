...
public abstract class EnergizedPowerBaseContainerScreen<T extends ScreenHandler> extends HandledScreen<T> {
    ...
    protected void renderFluidMeterContent(MatrixStack poseStack, FluidStack fluidStack, long tankCapacity, int x, int y,
                                           int w, int h) {
        ...
        renderFluidStack(poseStack, fluidStack, tankCapacity, w, h);
    ...
    private void renderFluidStack(MatrixStack poseStack, FluidStack fluidStack, long tankCapacity, int w, int h) {
