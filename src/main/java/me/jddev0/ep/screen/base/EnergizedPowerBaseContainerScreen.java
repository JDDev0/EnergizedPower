...
public abstract class EnergizedPowerBaseContainerScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
    ...
    protected void renderFluidMeterContent(PoseStack poseStack, FluidStack fluidStack, int tankCapacity, int x, int y,
                                           int w, int h) {
    ...
    private void renderFluidStack(PoseStack poseStack, FluidStack fluidStack, int tankCapacity, int w, int h) {
