...
public abstract class ConfigurableIOUpgradableEnergyStorageContainerScreen
    ...
    protected ResourceLocation ioConfigurationViewTexture = EPAPI.id("textures/gui/container/io_configuration_view/default.png");
    ...
    protected void renderConfiguration(GuiGraphics guiGraphics, int x, int y, int mouseX, int mouseY) {
        ...
        //IO Configuration view
        if(isHovering(-22, 74, 20, 20, mouseX, mouseY)) {
            guiGraphics.blit(CONFIGURATION_ICONS_TEXTURE, x - 22, y + 74, 40, 100, 20, 20, 256, 256);
        }else if(menu.isInIOConfigurationView()) {
            guiGraphics.blit(CONFIGURATION_ICONS_TEXTURE, x - 22, y + 74, 20, 100, 20, 20, 256, 256);
        }else {
            guiGraphics.blit(CONFIGURATION_ICONS_TEXTURE, x - 22, y + 74, 0, 100, 20, 20, 256, 256);
        }
    ...
    protected void renderIOConfigurationView(GuiGraphics guiGraphics, int x, int y, int mouseX, int mouseY) {
        guiGraphics.blit(ioConfigurationViewTexture, x + ioConfigurationViewX, y + ioConfigurationViewY, 0, 0,
        ...
        if(isHovering(ioConfigurationViewX, ioConfigurationViewY, 20, 20, mouseX, mouseY)) {
            guiGraphics.blit(CONFIGURATION_ICONS_TEXTURE, x + ioConfigurationViewX, y + ioConfigurationViewY, 20 * ordinal, 140,
                    20, 20, 256, 256);
        }else {
            guiGraphics.blit(CONFIGURATION_ICONS_TEXTURE, x + ioConfigurationViewX, y + ioConfigurationViewY, 20 * ordinal, 120,
                    20, 20, 256, 256);
        }
    ...
    protected void extractTooltipIOConfigurationView(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        if(isHovering(ioConfigurationViewX, ioConfigurationViewY, 20, 20, mouseX, mouseY)) {
            //Toggle slot type mode
    ...
    protected void renderLabels(GuiGraphics graphics, int xm, int ym) {
        ...
        graphics.drawString(this.font, menu.isInIOConfigurationView()?this.ioConfigurationViewLabel:this.playerInventoryTitle, this.inventoryLabelX, this.inventoryLabelY, -12566464, false);
    }
}
