...
public class TimeControllerScreen extends HandledScreen<TimeControllerMenu> {
    ...
    protected void drawMouseoverTooltip(MatrixStack poseStack, int mouseX, int mouseY) {
        ...
        if(isPointWithinBounds(8, 17, 16, 52, mouseX, mouseY)) {
            ...
            List<Text> components = new ArrayList<>(2);
            components.add(new TranslatableText("tooltip.energizedpower.time_controller.btn.day"));
            ...
            List<Text> components = new ArrayList<>(2);
            components.add(new TranslatableText("tooltip.energizedpower.time_controller.btn.noon"));
            ...
            List<Text> components = new ArrayList<>(2);
            components.add(new TranslatableText("tooltip.energizedpower.time_controller.btn.night"));
            ...
            List<Text> components = new ArrayList<>(2);
            components.add(new TranslatableText("tooltip.energizedpower.time_controller.btn.midnight"));
