...
public class EnergizedPowerBookScreen extends Screen {
    ...
    private void createMenuControls() {
        ...
        addRenderableWidget(new Button(width / 2 - 116, 232, showTakeButton?116:236, 20, CommonComponents.GUI_DONE, button -> onClose()));

        if(showTakeButton)
            addRenderableWidget(new Button(width / 2 + 2, 232, 116, 20, Component.translatable("lectern.take_book"), button -> {
