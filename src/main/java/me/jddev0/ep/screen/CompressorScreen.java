...
public class CompressorScreen extends ConfigurableIOUpgradableEnergyStorageContainerScreen<CompressorMenu> {
    ...
    private void renderProgressArrow(GuiGraphics drawContext, int x, int y) {
        if(menu.isCraftingActive())
            drawContext.blit(MACHINE_SPRITES_TEXTURE, x + 79, y + 30, 16, 79, menu.getScaledProgressArrowSize(), 25);
    }
}
