...
public class PlantGrowthChamberScreen extends HandledScreen<PlantGrowthChamberMenu> {
    private static final Identifier TEXTURE = new Identifier(EnergizedPowerMod.MODID, "textures/gui/container/plant_growth_chamber.png");
    ...
    private void renderProgressArrow(MatrixStack poseStack, int x, int y) {
        if(handler.isCraftingActive())
            drawTexture(poseStack, x + 94, y + 34, 176, 52, handler.getScaledProgressArrowSize(), 17);
    }
