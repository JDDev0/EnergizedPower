...
public class PlantGrowthChamberScreen extends AbstractGenericEnergyStorageHandledScreen<PlantGrowthChamberMenu> {
    public PlantGrowthChamberScreen(PlantGrowthChamberMenu menu, PlayerInventory inventory, Text component) {
        super(menu, inventory, component,
                "tooltip.energizedpower.recipe.energy_required_to_finish.txt",
                new Identifier(EnergizedPowerMod.MODID, "textures/gui/container/plant_growth_chamber.png"),
                8, 17);
    }
