...
public class AdvancedPulverizerMenu extends UpgradableEnergyStorageMenu<AdvancedPulverizerBlockEntity>
    ...
    public AdvancedPulverizerMenu(int id, Inventory inv, BlockPos pos) {
        this(id, inv.player.level().getBlockEntity(pos), inv, new SimpleContainer(3) {
            ...
            public boolean canPlaceItem(int slot, ItemStack stack) {
                return switch(slot) {
                    case 0 -> RecipeUtils.isIngredientOfAny(inv.player.level(), PulverizerRecipe.Type.INSTANCE, stack);
                    case 1, 2 -> false;
    ...
    public AdvancedPulverizerMenu(int id, BlockEntity blockEntity, Inventory playerInventory, Container inv,
