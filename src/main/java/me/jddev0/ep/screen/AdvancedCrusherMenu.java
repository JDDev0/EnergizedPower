...
public class AdvancedCrusherMenu extends UpgradableEnergyStorageMenu<AdvancedCrusherBlockEntity>
    ...
    public AdvancedCrusherMenu(int id, PlayerInventory inv, BlockPos pos) {
        this(id, inv.player.getEntityWorld().getBlockEntity(pos), inv, new SimpleInventory(2) {
            @Override
            public boolean isValid(int slot, ItemStack stack) {
                return switch(slot) {
                    case 0 -> RecipeUtils.isIngredientOfAny(((AdvancedCrusherBlockEntity)inv.player.getEntityWorld().
