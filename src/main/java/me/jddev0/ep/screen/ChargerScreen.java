...
public class ChargerScreen extends AbstractContainerScreen<ChargerMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(EnergizedPowerMod.MODID, "textures/gui/container/charger.png");
    ...
    protected void renderTooltip(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        if(isHovering(8, 17, 16, 52, mouseX, mouseY)) {
            ...
            if(menu.getEnergyRequirement() > 0) {
                components.add(new TranslatableComponent("tooltip.energizedpower.charger.item_energy_left.txt",
