...
public class StoneLiquefierScreen
    ...
    private void renderFluidMeterOverlay(DrawContext drawContext, int x, int y) {
        drawContext.drawTexture(MACHINE_SPRITES_TEXTURE, x + 152, y + 17, 16, 0, 16, 52, 256, 256);
    }

    private void renderProgressArrow(DrawContext drawContext, int x, int y) {
        if(handler.isCraftingActive())
            drawContext.drawTexture(MACHINE_SPRITES_TEXTURE, x + 112, y + 34, 0, 58, handler.getScaledProgressArrowSize(), 17, 256, 256);
    }
