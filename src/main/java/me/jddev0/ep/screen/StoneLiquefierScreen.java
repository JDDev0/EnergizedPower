...
public class StoneLiquefierScreen
    ...
    public StoneLiquefierScreen(StoneLiquefierMenu menu, PlayerInventory inventory, Text component) {
    ...
    private void renderProgressArrow(DrawContext drawContext, int x, int y) {
        if(handler.isCraftingActive())
            drawContext.drawTexture(RenderPipelines.GUI_TEXTURED, MACHINE_SPRITES_TEXTURE, x + 112, y + 34, 0, 58, handler.getScaledProgressArrowSize(), 17, 256, 256);
    }
