...
public class EnergizerScreen
        extends ConfigurableIOUpgradableEnergyStorageContainerScreen<EnergizerMenu> {
    ...
    private void renderActiveOverlay(GuiGraphicsExtractor guiGraphics, int x, int y) {
        if(menu.isCraftingActive()) {
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, MACHINE_SPRITES_TEXTURE, x + 31, y + 18, 96, 58, 50, 50, 256, 256);
        }
    }
}
