...
public class SawmillMenu extends UpgradableEnergyStorageMenu<SawmillBlockEntity>
    ...
    public SawmillMenu(int id, Inventory inv, BlockPos pos) {
        this(id, inv.player.level().getBlockEntity(pos), inv, new SimpleContainer(3) {
            ...
            public boolean canPlaceItem(int slot, ItemStack stack) {
                return switch(slot) {
                    case 0 -> RecipeUtils.isIngredientOfAny(inv.player.level(), SawmillRecipe.Type.INSTANCE, stack);
                    case 1, 2 -> false;
    ...
    public SawmillMenu(int id, BlockEntity blockEntity, Inventory playerInventory, Container inv,
