...
public class AutoPressMoldMakerMenu extends ConfigurableIOUpgradableEnergyStorageMenu<AutoPressMoldMakerBlockEntity>
    ...
    public AutoPressMoldMakerMenu(int id, Inventory inv, BlockPos pos) {
