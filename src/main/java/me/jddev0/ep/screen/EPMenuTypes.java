...
public final class EPMenuTypes {
    ...
    public static final RegistryObject<MenuType<ItemConveyorBeltLoaderMenu>> BASIC_ITEM_CONVEYOR_BELT_LOADER_MENU = registerMenuType("item_conveyor_belt_loader",
            ItemConveyorBeltLoaderMenu::new);
    public static final RegistryObject<MenuType<ItemConveyorBeltLoaderMenu>> FAST_ITEM_CONVEYOR_BELT_LOADER_MENU = registerMenuType("fast_item_conveyor_belt_loader",
            ItemConveyorBeltLoaderMenu::new);
    public static final RegistryObject<MenuType<ItemConveyorBeltLoaderMenu>> EXPRESS_ITEM_CONVEYOR_BELT_LOADER_MENU = registerMenuType("express_item_conveyor_belt_loader",
            ItemConveyorBeltLoaderMenu::new);

    public static final RegistryObject<MenuType<ItemConveyorBeltSorterMenu>> BASIC_ITEM_CONVEYOR_BELT_SORTER_MENU = registerMenuType("item_conveyor_sorter_loader",
            ItemConveyorBeltSorterMenu::new);
    public static final RegistryObject<MenuType<ItemConveyorBeltSorterMenu>> FAST_ITEM_CONVEYOR_BELT_SORTER_MENU = registerMenuType("fast_conveyor_sorter_loader",
            ItemConveyorBeltSorterMenu::new);
    public static final RegistryObject<MenuType<ItemConveyorBeltSorterMenu>> EXPRESS_ITEM_CONVEYOR_BELT_SORTER_MENU = registerMenuType("express_conveyor_sorter_loader",
            ItemConveyorBeltSorterMenu::new);
    ...
    public static final RegistryObject<MenuType<StoneLiquefierMenu>> STONE_LIQUEFIER_MENU = registerMenuType("stone_liquefier",
    ...
    public static final RegistryObject<MenuType<FluidTransposerMenu>> FLUID_TRANSPOSER_MENU = registerMenuType("fluid_transposer",
    ...
    public static final RegistryObject<MenuType<TransformerMenu>> LV_TRANSFORMER_1_TO_N_MENU = registerMenuType("lv_transformer_1_to_n",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> LV_TRANSFORMER_3_TO_3_MENU = registerMenuType("lv_transformer_3_to_3",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> LV_TRANSFORMER_N_TO_1_MENU = registerMenuType("lv_transformer_n_to_1",
            TransformerMenu::new);

    public static final RegistryObject<MenuType<TransformerMenu>> MV_TRANSFORMER_1_TO_N_MENU = registerMenuType("mv_transformer_1_to_n",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> MV_TRANSFORMER_3_TO_3_MENU = registerMenuType("mv_transformer_3_to_3",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> MV_TRANSFORMER_N_TO_1_MENU = registerMenuType("mv_transformer_n_to_1",
            TransformerMenu::new);

    public static final RegistryObject<MenuType<TransformerMenu>> HV_TRANSFORMER_1_TO_N_MENU = registerMenuType("hv_transformer_1_to_n",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> HV_TRANSFORMER_3_TO_3_MENU = registerMenuType("hv_transformer_3_to_3",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> HV_TRANSFORMER_N_TO_1_MENU = registerMenuType("hv_transformer_n_to_1",
            TransformerMenu::new);

    public static final RegistryObject<MenuType<TransformerMenu>> EHV_TRANSFORMER_1_TO_N_MENU = registerMenuType("ehv_transformer_1_to_n",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> EHV_TRANSFORMER_3_TO_3_MENU = registerMenuType("ehv_transformer_3_to_3",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> EHV_TRANSFORMER_N_TO_1_MENU = registerMenuType("ehv_transformer_n_to_1",
            TransformerMenu::new);

    public static final RegistryObject<MenuType<TransformerMenu>> CONFIGURABLE_LV_TRANSFORMER_MENU = registerMenuType("configurable_lv_transformer",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> CONFIGURABLE_MV_TRANSFORMER_MENU = registerMenuType("configurable_mv_transformer",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> CONFIGURABLE_HV_TRANSFORMER_MENU = registerMenuType("configurable_hv_transformer",
            TransformerMenu::new);
    public static final RegistryObject<MenuType<TransformerMenu>> CONFIGURABLE_EHV_TRANSFORMER_MENU = registerMenuType("configurable_ehv_transformer",
            TransformerMenu::new);
    ...
    public static final RegistryObject<MenuType<AlloyFurnaceMenu>> ALLOY_FURNACE_MENU = registerMenuType("alloy_furnace",
