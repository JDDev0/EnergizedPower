...
public final class EPMenuTypes {
    ...
    public static final Supplier<MenuType<ItemConveyorBeltLoaderMenu>> EXPRESS_ITEM_CONVEYOR_BELT_LOADER_MENU = registerMenuType("express_item_conveyor_belt_loader",
            ItemConveyorBeltLoaderMenu::new);
    public static final Supplier<MenuType<ItemConveyorBeltLoaderMenu>> TURBO_ITEM_CONVEYOR_BELT_LOADER_MENU = registerMenuType("turbo_item_conveyor_belt_loader",
            ItemConveyorBeltLoaderMenu::new);
    ...
    public static final Supplier<MenuType<ItemConveyorBeltSorterMenu>> EXPRESS_ITEM_CONVEYOR_BELT_SORTER_MENU = registerMenuType("express_conveyor_sorter_loader",
            ItemConveyorBeltSorterMenu::new);
    public static final Supplier<MenuType<ItemConveyorBeltSorterMenu>> TURBO_ITEM_CONVEYOR_BELT_SORTER_MENU = registerMenuType("turbo_conveyor_sorter_loader",
            ItemConveyorBeltSorterMenu::new);
    ...
    public static final Supplier<MenuType<FluidPumpMenu>> FLUID_PUMP_MENU = registerMenuType("fluid_pump",
            FluidPumpMenu::new);

    public static final Supplier<MenuType<AdvancedFluidPumpMenu>> ADVANCED_FLUID_PUMP_MENU = registerMenuType("advanced_fluid_pump",
    ...
    public static final Supplier<MenuType<EliteChargerMenu>> ELITE_CHARGER_MENU = registerMenuType("elite_charger",
    ...
    public static final Supplier<MenuType<EliteMinecartChargerMenu>> ELITE_MINECART_CHARGER_MENU = registerMenuType("elite_minecart_charger",
    ...
    public static final Supplier<MenuType<EliteMinecartUnchargerMenu>> ELITE_MINECART_UNCHARGER_MENU = registerMenuType("elite_minecart_uncharger",
    ...
    public static final Supplier<MenuType<TransformerMenu>> UHV_TRANSFORMER_1_TO_N_MENU = registerMenuType("uhv_transformer_1_to_n",
            TransformerMenu::new);
    public static final Supplier<MenuType<TransformerMenu>> UHV_TRANSFORMER_3_TO_3_MENU = registerMenuType("uhv_transformer_3_to_3",
            TransformerMenu::new);
    public static final Supplier<MenuType<TransformerMenu>> UHV_TRANSFORMER_N_TO_1_MENU = registerMenuType("uhv_transformer_n_to_1",
            TransformerMenu::new);
    ...
    public static final Supplier<MenuType<TransformerMenu>> CONFIGURABLE_EHV_TRANSFORMER_MENU = registerMenuType("configurable_ehv_transformer",
            TransformerMenu::new);
    public static final Supplier<MenuType<TransformerMenu>> CONFIGURABLE_UHV_TRANSFORMER_MENU = registerMenuType("configurable_uhv_transformer",
            TransformerMenu::new);
    ...
    public static final Supplier<MenuType<AutoPressMoldMakerMenu>> AUTO_PRESS_MOLD_MAKER_MENU = registerMenuType("auto_press_mold_maker",
            AutoPressMoldMakerMenu::new);

    public static final Supplier<MenuType<AutoStonecutterMenu>> AUTO_STONECUTTER_MENU = registerMenuType("auto_stonecutter",
    ...
    public static final Supplier<MenuType<InductionSmelterMenu>> INDUCTION_SMELTER_MENU = registerMenuType("induction_smelter",
    ...
    public static final Supplier<MenuType<ItemSiloMenu>> ITEM_SILO_SMALL = registerMenuType("item_silo_small",
            ItemSiloMenu::new);
    public static final Supplier<MenuType<ItemSiloMenu>> ITEM_SILO_MEDIUM = registerMenuType("item_silo_medium",
            ItemSiloMenu::new);
    public static final Supplier<MenuType<ItemSiloMenu>> ITEM_SILO_LARGE = registerMenuType("item_silo_large",
            ItemSiloMenu::new);
    public static final Supplier<MenuType<ItemSiloMenu>> ITEM_SILO_GIANT = registerMenuType("item_silo_giant",
            ItemSiloMenu::new);
