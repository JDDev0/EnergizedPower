...
public class MinecartChargerMenu extends ScreenHandler implements EnergyStorageMenuPacketUpdate {
    ...
    public MinecartChargerMenu(int id, BlockEntity blockEntity, PlayerInventory playerInventory, Inventory inv, PropertyDelegate data) {
