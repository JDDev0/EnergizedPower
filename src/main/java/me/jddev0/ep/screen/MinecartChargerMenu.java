...
public class MinecartChargerMenu extends AbstractContainerMenu implements EnergyStorageMenu, EnergyStorageMenuPacketUpdate {
    ...
    public MinecartChargerMenu(int id, Inventory inv, BlockEntity blockEntity, ContainerData data) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.MINECART_CHARGER.get());
    }
