...
public class AutoStonecutterMenu extends AbstractEnergizedPowerScreenHandler
    ...
    public AutoStonecutterMenu(int id, PlayerInventory inv, PacketByteBuf buffer) {
    ...
    public AutoStonecutterMenu(int id, BlockEntity blockEntity, PlayerInventory playerInventory, Inventory inv,
        ...
        super(ModMenuTypes.AUTO_STONECUTTER_MENU, id);

        this.inv = inv;
        checkSize(this.inv, 3);
        checkSize(upgradeModuleInventory, 3);
        checkDataCount(data, 11);
        this.blockEntity = (AutoStonecutterBlockEntity)blockEntity;
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(ScreenHandlerContext.create(level, blockEntity.getPos()), player, ModBlocks.AUTO_STONECUTTER);
    }
    ...
    public StonecuttingRecipe getCurrentRecipe() {
