...
public class FluidDrainerBlock extends BlockWithEntity {
    public static final MapCodec<FluidDrainerBlock> CODEC = createCodec(FluidDrainerBlock::new);

    public static final BooleanProperty POWERED = Properties.POWERED;

    public FluidDrainerBlock(AbstractBlock.Settings props) {
        super(props);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, EPBlockEntities.FLUID_DRAINER_ENTITY, FluidDrainerBlockEntity::tick);
    }
}
