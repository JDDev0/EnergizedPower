...
public class EliteBatteryBoxBlock extends HorizontallyOrientableWorkerMachineBlock<EliteBatteryBoxBlockEntity> {
    public static final MapCodec<EliteBatteryBoxBlock> CODEC = simpleCodec(EliteBatteryBoxBlock::new);
    ...
    public static class Item extends BlockItem {
        ...
        @Override
        public void appendHoverText(ItemStack stack, AdvancedBatteryBoxBlock.Item.TooltipContext context, List<Component> tooltip, TooltipFlag type) {
