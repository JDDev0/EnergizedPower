...
public class StoneSolidifierBlock extends BlockWithEntity {
    public static final MapCodec<StoneSolidifierBlock> CODEC = createCodec(StoneSolidifierBlock::new);

    public static final BooleanProperty POWERED = Properties.POWERED;
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    protected StoneSolidifierBlock(AbstractBlock.Settings props) {
        super(props);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.STONE_SOLIDIFIER_ENTITY, StoneSolidifierBlockEntity::tick);
    }
}
