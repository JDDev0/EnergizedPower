...
public class CreativeItemSiloBlockEntity
    ...
    @Override
    protected void readInventoryStorage(@NotNull NbtCompound nbt) {
        itemHandler.readNbt(nbt);
    }

    @Override
    protected NbtCompound writeInventoryStorage(@NotNull NbtCompound nbt) {
        itemHandler.writeNbt(nbt);
        return nbt;
    }
