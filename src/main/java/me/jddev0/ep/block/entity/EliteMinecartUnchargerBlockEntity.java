...
public class EliteMinecartUnchargerBlockEntity extends AbstractMinecartUnchargerBlockEntity {
    public static final int MAX_TRANSFER = ModConfigs.COMMON_ELITE_MINECART_UNCHARGER_TRANSFER_RATE.getValue();

    public EliteMinecartUnchargerBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EPBlockEntities.ELITE_MINECART_UNCHARGER_ENTITY.get(), blockPos, blockState,
