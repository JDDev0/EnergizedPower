        ...
        data = new PropertyDelegate() {
            ...
            public int get(int index) {
                return switch(index) {
                    ...
                    case 2 -> (int)BlockPlacerBlockEntity.this.internalEnergyStorage.amount;
                    case 3 -> (int)BlockPlacerBlockEntity.this.internalEnergyStorage.capacity;
                    case 4 -> (int)BlockPlacerBlockEntity.this.energyConsumptionLeft;
            ...
            public void set(int index, int value) {
                switch(index) {
                    ...
                    case 2 -> BlockPlacerBlockEntity.this.internalEnergyStorage.amount = value;
                    case 3, 4, 5 -> {}
                }
            }
