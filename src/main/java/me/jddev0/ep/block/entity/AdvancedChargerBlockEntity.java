            ...
            if(blockEntity.hasRecipe(i)) {
                ...
                if(blockEntity.energyConsumptionLeft[i] <= 0) {
                    ...
                    recipe.ifPresent(advancedChargerRecipe ->
                            blockEntity.itemHandler.setStack(index, advancedChargerRecipe.getOutput(level.getRegistryManager()).copyWithCount(1)));
    ...
    protected final long getEnergyConsumptionPerTickSum() {
        ...
        for(int i = 0;i < 3;i++) {
            ...
            Optional<ChargerRecipe> recipe = world.getRecipeManager().
                    getFirstMatch(ChargerRecipe.Type.INSTANCE, inventory, world);
