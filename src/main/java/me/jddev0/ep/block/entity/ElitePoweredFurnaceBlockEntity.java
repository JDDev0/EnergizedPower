...
public class ElitePoweredFurnaceBlockEntity extends AbstractPoweredFurnaceBlockEntity {
    public static final long TANK_CAPACITY = FluidUtils.convertMilliBucketsToDroplets(1000 * ModConfigs.COMMON_ELITE_POWERED_FURNACE_FLUID_TANK_CAPACITY.getValue());

    public ElitePoweredFurnaceBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EPBlockEntities.ELITE_POWERED_FURNACE_ENTITY, blockPos, blockState,
