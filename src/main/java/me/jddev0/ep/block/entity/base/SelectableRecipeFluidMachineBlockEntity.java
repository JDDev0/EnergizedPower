...
public abstract class SelectableRecipeFluidMachineBlockEntity
        ...
        implements ExtendedScreenHandlerFactory<BlockPos>, ChangeCurrentRecipeIndexPacketUpdate, CurrentRecipePacketUpdate<R> {
    ...
    public static <F extends Storage<FluidVariant>, R extends Recipe<Inventory>> void tick(
        ...
        if(blockEntity.currentRecipeIdForLoad != null) {
            List<RecipeEntry<R>> recipes = level.getRecipeManager().listAllOfType(blockEntity.recipeType);
