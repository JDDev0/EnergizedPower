...
public class AssemblingMachineBlockEntity extends SimpleRecipeMachineBlockEntity<AssemblingMachineRecipe> {
    ...
    protected void craftItem(AssemblingMachineRecipe recipe) {
        ...
        itemHandler.setStack(4, recipe.getOutput(world.getRegistryManager()).copyWithCount(
    ...
    @Override
    protected boolean canCraftRecipe(SimpleInventory inventory, AssemblingMachineRecipe recipe) {
        return world != null &&
                InventoryUtils.canInsertItemIntoSlot(inventory, 4, recipe.getOutput(world.getRegistryManager()));
    }
}