...
public class EliteAutoCrafterBlockEntity extends AbstractAutoCrafterBlockEntity {
    public final static int ENERGY_CONSUMPTION_PER_TICK_PER_INGREDIENT = ModConfigs.COMMON_ELITE_AUTO_CRAFTER_ENERGY_CONSUMPTION_PER_TICK_PER_INGREDIENT.getValue();

    public EliteAutoCrafterBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EPBlockEntities.ELITE_AUTO_CRAFTER_ENTITY.get(), blockPos, blockState,
