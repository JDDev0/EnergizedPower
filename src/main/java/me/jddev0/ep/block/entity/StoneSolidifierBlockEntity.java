...
public class StoneSolidifierBlockEntity
    ...
    public StoneSolidifierBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                ModBlockEntities.STONE_SOLIDIFIER_ENTITY, blockPos, blockState,

                "stone_solidifier", StoneSolidifierMenu::new,

                1,
                ModRecipes.STONE_SOLIDIFIER_TYPE,
                ModRecipes.STONE_SOLIDIFIER_SERIALIZER,
    ...
    protected void craftItem(StoneSolidifierRecipe recipe) {
        ...
        itemHandler.setStack(0, recipe.getOutput(world.getRegistryManager()).
    ...
    protected boolean canCraftRecipe(SimpleInventory inventory, StoneSolidifierRecipe recipe) {
        return world != null &&
                ...
                InventoryUtils.canInsertItemIntoSlot(inventory, 0, recipe.getOutput(world.getRegistryManager()));
    }
}