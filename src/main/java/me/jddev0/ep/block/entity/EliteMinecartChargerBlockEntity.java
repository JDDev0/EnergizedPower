...
public class EliteMinecartChargerBlockEntity extends AbstractMinecartChargerBlockEntity {
    public static final int MAX_TRANSFER = ModConfigs.COMMON_ELITE_MINECART_CHARGER_TRANSFER_RATE.getValue();

    public EliteMinecartChargerBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EPBlockEntities.ELITE_MINECART_CHARGER_ENTITY.get(), blockPos, blockState,
