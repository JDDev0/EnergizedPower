...
public class SawmillBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, EnergyStoragePacketUpdate, RedstoneModeUpdate,
    ...
    public ScreenHandler createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
        ...
        return new SawmillMenu(id, this, inventory, internalInventory, upgradeModuleInventory, this.data);
    }
