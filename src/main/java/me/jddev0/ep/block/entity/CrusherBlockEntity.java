        ...
        data = new PropertyDelegate() {
            ...
            public int get(int index) {
                return switch(index) {
                    ...
                    case 2 -> (int)CrusherBlockEntity.this.internalEnergyStorage.amount;
                    case 3 -> (int)CrusherBlockEntity.this.internalEnergyStorage.capacity;
                    case 4 -> (int)CrusherBlockEntity.this.energyConsumptionLeft;
            ...
            public void set(int index, int value) {
                switch(index) {
                    ...
                    case 2 -> CrusherBlockEntity.this.internalEnergyStorage.amount = value;
                    case 3, 4, 5 -> {}
                }
            }
