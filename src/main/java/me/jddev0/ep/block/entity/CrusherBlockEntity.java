...
public class CrusherBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, EnergyStoragePacketUpdate, RedstoneModeUpdate,
    ...
    public CrusherBlockEntity(BlockPos blockPos, BlockState blockState) {
        ...
        internalInventory = new SimpleInventory(2) {
            ...
            public void markDirty() {
                ...
                CrusherBlockEntity.this.markDirty();
            }
        };
        ...
        data = new PropertyDelegate() {
            ...
            public void set(int index, int value) {
                switch(index) {
                    ...
                    case 10 -> CrusherBlockEntity.this.comparatorMode = ComparatorMode.fromIndex(value);
                }
            }
    ...
    public ScreenHandler createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
        ...
        return new CrusherMenu(id, this, inventory, internalInventory, upgradeModuleInventory, this.data);
    }
    ...
    public static void tick(World level, BlockPos blockPos, BlockState state, CrusherBlockEntity blockEntity) {
        ...
        if(hasRecipe(blockEntity)) {
            Optional<RecipeEntry<CrusherRecipe>> recipe = level.getRecipeManager().getFirstMatch(CrusherRecipe.Type.INSTANCE, blockEntity.internalInventory, level);
            if(recipe.isEmpty())
                return;
