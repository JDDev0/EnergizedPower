...
public class EliteBatteryBoxBlockEntity extends MenuEnergyStorageBlockEntity<EnergizedPowerEnergyStorage>
    ...
    public static final long CAPACITY = ModConfigs.COMMON_ELITE_BATTERY_BOX_CAPACITY.getValue();
    public static final long MAX_TRANSFER = ModConfigs.COMMON_ELITE_BATTERY_BOX_TRANSFER_RATE.getValue();

    public EliteBatteryBoxBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EPBlockEntities.ELITE_BATTERY_BOX_ENTITY, blockPos, blockState,
