...
public class CompressorBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, EnergyStoragePacketUpdate, RedstoneModeUpdate,
        ...
        data = new PropertyDelegate() {
            ...
            public void set(int index, int value) {
                switch(index) {
                    ...
                    case 4, 5, 6, 7, 8 -> {}
                    case 9 -> CompressorBlockEntity.this.redstoneMode = RedstoneMode.fromIndex(value);
                    case 10 -> CompressorBlockEntity.this.comparatorMode = ComparatorMode.fromIndex(value);
                }
            }
    ...
    public ScreenHandler createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
        ...
        return new CompressorMenu(id, this, inventory, internalInventory, upgradeModuleInventory, this.data);
    }
    ...
    public static void tick(World level, BlockPos blockPos, BlockState state, CompressorBlockEntity blockEntity) {
        ...
        if(!blockEntity.redstoneMode.isActive(state.get(ComparatorBlock.POWERED)))
            return;
