...
public class AdvancedUnchargerBlock extends BlockWithEntity {
    public static final MapCodec<AdvancedUnchargerBlock> CODEC = createCodec(AdvancedUnchargerBlock::new);

    public static final BooleanProperty POWERED = Properties.POWERED;

    public AdvancedUnchargerBlock(AbstractBlock.Settings props) {
        super(props);
