...
public class PlantGrowthChamberBlock extends BlockWithEntity {
    public static final MapCodec<PlantGrowthChamberBlock> CODEC = createCodec(PlantGrowthChamberBlock::new);

    public static final BooleanProperty POWERED = Properties.POWERED;
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    protected PlantGrowthChamberBlock(AbstractBlock.Settings props) {
        super(props);
    ...
    public BlockEntity createBlockEntity(BlockPos blockPos, BlockState state) {
        return new PlantGrowthChamberBlockEntity(blockPos, state);
    }
    ...
    public int getComparatorOutput(BlockState state, World level, BlockPos blockPos) {
        ...
        if(!(blockEntity instanceof PlantGrowthChamberBlockEntity plantGrowthChamberBlockEntity))
            return super.getComparatorOutput(state, level, blockPos);

        return plantGrowthChamberBlockEntity.getRedstoneOutput();
    }
    ...
    public void onStateReplaced(BlockState state, World level, BlockPos blockPos, BlockState newState, boolean isMoving) {
        ...
        ((PlantGrowthChamberBlockEntity)blockEntity).drops(level, blockPos);
    ...
    public ActionResult onUse(BlockState state, World level, BlockPos blockPos, PlayerEntity player, BlockHitResult hit) {
        ...
        player.openHandledScreen((PlantGrowthChamberBlockEntity)blockEntity);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, EPBlockEntities.PLANT_GROWTH_CHAMBER_ENTITY, PlantGrowthChamberBlockEntity::tick);
    }
}
