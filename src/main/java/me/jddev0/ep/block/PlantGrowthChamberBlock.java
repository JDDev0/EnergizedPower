...
public class PlantGrowthChamberBlock extends BlockWithEntity {
    public static final MapCodec<PlantGrowthChamberBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, PlantGrowthChamberBlock::new);
    });

    public static final BooleanProperty POWERED = Properties.POWERED;
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    protected PlantGrowthChamberBlock(FabricBlockSettings props) {
        super(props);
