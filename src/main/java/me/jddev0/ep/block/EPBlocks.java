...
public final class EPBlocks {
    ...
    public static final RegistryObject<ItemSiloBlock> ITEM_SILO_TINY = BLOCKS.register("item_silo_tiny",
            () -> new ItemSiloBlock(ItemSiloTier.TINY, ItemSiloTier.TINY.getProperties()));
    public static final RegistryObject<Item> ITEM_SILO_TINY_ITEM = EPItems.ITEMS.register("item_silo_tiny",
            () -> new ItemSiloBlock.Item(ITEM_SILO_TINY.get(), new Item.Properties(), ItemSiloTier.TINY));

    public static final RegistryObject<ItemSiloBlock> ITEM_SILO_SMALL = BLOCKS.register("item_silo_small",
            () -> new ItemSiloBlock(ItemSiloTier.SMALL, ItemSiloTier.SMALL.getProperties()));
    public static final RegistryObject<Item> ITEM_SILO_SMALL_ITEM = EPItems.ITEMS.register("item_silo_small",
            () -> new ItemSiloBlock.Item(ITEM_SILO_SMALL.get(), new Item.Properties(), ItemSiloTier.SMALL));

    public static final RegistryObject<ItemSiloBlock> ITEM_SILO_MEDIUM = BLOCKS.register("item_silo_medium",
            () -> new ItemSiloBlock(ItemSiloTier.MEDIUM, ItemSiloTier.MEDIUM.getProperties()));
    public static final RegistryObject<Item> ITEM_SILO_MEDIUM_ITEM = EPItems.ITEMS.register("item_silo_medium",
            () -> new ItemSiloBlock.Item(ITEM_SILO_MEDIUM.get(), new Item.Properties(), ItemSiloTier.MEDIUM));

    public static final RegistryObject<ItemSiloBlock> ITEM_SILO_LARGE = BLOCKS.register("item_silo_large",
            () -> new ItemSiloBlock(ItemSiloTier.LARGE, ItemSiloTier.LARGE.getProperties()));
    public static final RegistryObject<Item> ITEM_SILO_LARGE_ITEM = EPItems.ITEMS.register("item_silo_large",
            () -> new ItemSiloBlock.Item(ITEM_SILO_LARGE.get(), new Item.Properties(), ItemSiloTier.LARGE));

    public static final RegistryObject<ItemSiloBlock> ITEM_SILO_GIANT = BLOCKS.register("item_silo_giant",
            () -> new ItemSiloBlock(ItemSiloTier.GIANT, ItemSiloTier.GIANT.getProperties()));
    public static final RegistryObject<Item> ITEM_SILO_GIANT_ITEM = EPItems.ITEMS.register("item_silo_giant",
            () -> new ItemSiloBlock.Item(ITEM_SILO_GIANT.get(), new Item.Properties(), ItemSiloTier.GIANT));

    public static final RegistryObject<CreativeItemSiloBlock> CREATIVE_ITEM_SILO = BLOCKS.register("creative_item_silo",
            () -> new CreativeItemSiloBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).
                    requiresCorrectToolForDrops().strength(-1.f, 3600000.f).noLootTable()));
    public static final RegistryObject<Item> CREATIVE_ITEM_SILO_ITEM = EPItems.ITEMS.register("creative_item_silo",
    ...
    private static RegistryObject<Item> createConfigurableTransformerBlockItem(String name, RegistryObject<ConfigurableTransformerBlock> block) {
        return EPItems.ITEMS.register(name, () -> new ConfigurableTransformerBlock.Item(block.get(), new Item.Properties(), block.get().getTier()));
    }
    public static final RegistryObject<ConfigurableTransformerBlock> CONFIGURABLE_LV_TRANSFORMER = BLOCKS.register("configurable_lv_transformer",
            () -> new ConfigurableTransformerBlock(TransformerTier.LV, BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final RegistryObject<Item> CONFIGURABLE_LV_TRANSFORMER_ITEM = createConfigurableTransformerBlockItem("configurable_lv_transformer",
            CONFIGURABLE_LV_TRANSFORMER);

    public static final RegistryObject<ConfigurableTransformerBlock> CONFIGURABLE_MV_TRANSFORMER = BLOCKS.register("configurable_mv_transformer",
            () -> new ConfigurableTransformerBlock(TransformerTier.MV, BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final RegistryObject<Item> CONFIGURABLE_MV_TRANSFORMER_ITEM = createConfigurableTransformerBlockItem("configurable_mv_transformer",
            CONFIGURABLE_MV_TRANSFORMER);

    public static final RegistryObject<ConfigurableTransformerBlock> CONFIGURABLE_HV_TRANSFORMER = BLOCKS.register("configurable_hv_transformer",
            () -> new ConfigurableTransformerBlock(TransformerTier.HV, BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final RegistryObject<Item> CONFIGURABLE_HV_TRANSFORMER_ITEM = createConfigurableTransformerBlockItem("configurable_hv_transformer",
            CONFIGURABLE_HV_TRANSFORMER);

    public static final RegistryObject<ConfigurableTransformerBlock> CONFIGURABLE_EHV_TRANSFORMER = BLOCKS.register("configurable_ehv_transformer",
            () -> new ConfigurableTransformerBlock(TransformerTier.EHV, BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final RegistryObject<Item> CONFIGURABLE_EHV_TRANSFORMER_ITEM = createConfigurableTransformerBlockItem("configurable_ehv_transformer",
    ...
    public static final RegistryObject<Item> INDUCTION_SMELTER_ITEM = createBlockItem("induction_smelter", INDUCTION_SMELTER);
    ...
    public static final RegistryObject<Block> STONE_LIQUEFIER = BLOCKS.register("stone_liquefier",
            () -> new StoneLiquefierBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final RegistryObject<Item> STONE_LIQUEFIER_ITEM = createBlockItem("stone_liquefier", STONE_LIQUEFIER);
    ...
    public static final RegistryObject<Block> ADVANCED_FLUID_PUMP = BLOCKS.register("advanced_fluid_pump",
            () -> new AdvancedFluidPumpBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final RegistryObject<Item> ADVANCED_FLUID_PUMP_ITEM = createBlockItem("advanced_fluid_pump", ADVANCED_FLUID_PUMP);
