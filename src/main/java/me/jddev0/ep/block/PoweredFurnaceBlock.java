...
public class PoweredFurnaceBlock extends BlockWithEntity {
    public static final MapCodec<PoweredFurnaceBlock> CODEC = createCodec(PoweredFurnaceBlock::new);
    ...
    protected PoweredFurnaceBlock(AbstractBlock.Settings props) {
        super(props);
    ...
    public ActionResult onUse(BlockState state, World level, BlockPos blockPos, PlayerEntity player, BlockHitResult hit) {
        ...
        player.openHandledScreen((PoweredFurnaceBlockEntity)blockEntity);
