...
public class SawmillBlock extends BlockWithEntity {
    public static final MapCodec<SawmillBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, SawmillBlock::new);
    });

    public static final BooleanProperty POWERED = Properties.POWERED;

    public SawmillBlock(FabricBlockSettings props) {
        super(props);
    ...
    public ActionResult onUse(BlockState state, World level, BlockPos blockPos, PlayerEntity player, Hand handItem, BlockHitResult hit) {
        ...
        player.openHandledScreen((SawmillBlockEntity)blockEntity);
