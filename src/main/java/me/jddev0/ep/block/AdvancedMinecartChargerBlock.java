...
public class AdvancedMinecartChargerBlock extends BlockWithEntity {
    public static final MapCodec<AdvancedMinecartChargerBlock> CODEC = createCodec(AdvancedMinecartChargerBlock::new);

    public static final EnumProperty<Direction> FACING = Properties.FACING;

    protected AdvancedMinecartChargerBlock(AbstractBlock.Settings props) {
        super(props);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, EPBlockEntities.ADVANCED_MINECART_CHARGER_ENTITY, AdvancedMinecartChargerBlockEntity::tick);
    }
