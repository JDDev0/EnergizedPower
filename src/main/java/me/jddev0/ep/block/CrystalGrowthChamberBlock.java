...
public class CrystalGrowthChamberBlock extends BlockWithEntity {
    public static final MapCodec<CrystalGrowthChamberBlock> CODEC = createCodec(CrystalGrowthChamberBlock::new);

    public static final BooleanProperty POWERED = Properties.POWERED;

    public CrystalGrowthChamberBlock(AbstractBlock.Settings props) {
        super(props);
