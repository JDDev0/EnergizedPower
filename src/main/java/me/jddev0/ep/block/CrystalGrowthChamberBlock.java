...
public class CrystalGrowthChamberBlock extends BlockWithEntity {
    public static final MapCodec<CrystalGrowthChamberBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, CrystalGrowthChamberBlock::new);
    });

    public static final BooleanProperty POWERED = Properties.POWERED;

    public CrystalGrowthChamberBlock(FabricBlockSettings props) {
        super(props);
    ...
    public ActionResult onUse(BlockState state, World level, BlockPos blockPos, PlayerEntity player, Hand handItem, BlockHitResult hit) {
        ...
        player.openHandledScreen((CrystalGrowthChamberBlockEntity)blockEntity);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.CRYSTAL_GROWTH_CHAMBER_ENTITY, CrystalGrowthChamberBlockEntity::tick);
    }
}
