...
public class AdvancedPoweredFurnaceBlock extends BlockWithEntity {
    public static final MapCodec<AdvancedPoweredFurnaceBlock> CODEC = createCodec(AdvancedPoweredFurnaceBlock::new);
    ...
    protected AdvancedPoweredFurnaceBlock(AbstractBlock.Settings props) {
        super(props);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.ADVANCED_POWERED_FURNACE_ENTITY, AdvancedPoweredFurnaceBlockEntity::tick);
    }
}
