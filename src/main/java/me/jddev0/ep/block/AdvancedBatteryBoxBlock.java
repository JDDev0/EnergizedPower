...
public class AdvancedBatteryBoxBlock extends BlockWithEntity {
    public static final MapCodec<AdvancedBatteryBoxBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, AdvancedBatteryBoxBlock::new);
    });

    public AdvancedBatteryBoxBlock(FabricBlockSettings props) {
        super(props);
    }
