...
public class AssemblingMachineBlock extends BlockWithEntity {
    public static final MapCodec<AssemblingMachineBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, AssemblingMachineBlock::new);
    });

    public static final BooleanProperty POWERED = Properties.POWERED;
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    protected AssemblingMachineBlock(FabricBlockSettings props) {
        super(props);
    ...
    public ActionResult onUse(BlockState state, World level, BlockPos blockPos, PlayerEntity player, Hand handItem, BlockHitResult hit) {
        ...
        player.openHandledScreen((AssemblingMachineBlockEntity)blockEntity);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.ASSEMBLING_MACHINE_ENTITY, AssemblingMachineBlockEntity::tick);
    }
}
