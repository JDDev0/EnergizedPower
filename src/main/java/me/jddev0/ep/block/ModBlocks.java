...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> TIN_ORE = BLOCKS.register("tin_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .requiresCorrectToolForDrops().strength(3.0f, 3.0f), ConstantInt.of(0)));
    ...
    public static final RegistryObject<Block> ITEM_CONVEYOR_BELT_SORTER = BLOCKS.register("item_conveyor_belt_sorter",
            () -> new ItemConveyorBeltSorterBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.STONE).
                    requiresCorrectToolForDrops().strength(3.5f).sound(SoundType.STONE)));
    ...
    public static final RegistryObject<Block> ITEM_CONVEYOR_BELT_SWITCH = BLOCKS.register("item_conveyor_belt_switch",
            () -> new ItemConveyorBeltSwitchBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.STONE).
                    requiresCorrectToolForDrops().strength(3.5f).sound(SoundType.STONE)));
    ...
    public static final RegistryObject<Block> ITEM_CONVEYOR_BELT_SPLITTER = BLOCKS.register("item_conveyor_belt_splitter",
            () -> new ItemConveyorBeltSplitterBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.STONE).
                    requiresCorrectToolForDrops().strength(3.5f).sound(SoundType.STONE)));
    ...
    public static final RegistryObject<Block> ALLOY_FURNACE = BLOCKS.register("alloy_furnace",
            () -> new AlloyFurnaceBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_RED).
                    requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.STONE).
    ...
    public static final RegistryObject<Block> AUTO_STONECUTTER = BLOCKS.register("auto_stonecutter",
            () -> new AutoStonecutterBlock(BlockBehaviour.Properties.of(Material.METAL).
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> ASSEMBLING_MACHINE = BLOCKS.register("assembling_machine",
            () -> new AssemblingMachineBlock(BlockBehaviour.Properties.of(Material.METAL).
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> INDUCTION_SMELTER = BLOCKS.register("induction_smelter",
            () -> new InductionSmelterBlock(BlockBehaviour.Properties.of(Material.METAL).
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL).
    ...
    public static final RegistryObject<Block> STONE_SOLIDIFIER = BLOCKS.register("stone_solidifier",
            () -> new StoneSolidifierBlock(BlockBehaviour.Properties.of(Material.METAL).
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> FLUID_PUMP = BLOCKS.register("fluid_pump",
            () -> new FluidPumpBlock(BlockBehaviour.Properties.of(Material.METAL).
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
