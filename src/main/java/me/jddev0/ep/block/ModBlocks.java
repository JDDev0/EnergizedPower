...
public final class ModBlocks {
    ...
    public static final Block ITEM_CONVEYOR_BELT_SWITCH = registerBlock("item_conveyor_belt_switch",
            new ItemConveyorBeltSwitchBlock(FabricBlockSettings.of(Material.STONE, MapColor.STONE_GRAY).
                    requiresTool().strength(3.5f).sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block ITEM_CONVEYOR_BELT_SPLITTER = registerBlock("item_conveyor_belt_splitter",
            new ItemConveyorBeltSplitterBlock(FabricBlockSettings.of(Material.STONE, MapColor.STONE_GRAY).
                    requiresTool().strength(3.5f).sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block ITEM_CONVEYOR_BELT_MERGER = registerBlock("item_conveyor_belt_merger",
            new ItemConveyorBeltMergerBlock(FabricBlockSettings.of(Material.STONE, MapColor.STONE_GRAY).
                    requiresTool().strength(3.5f).sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block ALLOY_FURNACE = registerBlock("alloy_furnace",
            new AlloyFurnaceBlock(FabricBlockSettings.of(Material.STONE, MapColor.RED).
                    requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.STONE).
    ...
    public static final Block AUTO_STONECUTTER = registerBlock("auto_stonecutter",
            new AutoStonecutterBlock(FabricBlockSettings.of(Material.METAL).
                    requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block INDUCTION_SMELTER = registerBlock("induction_smelter",
            new InductionSmelterBlock(AbstractBlock.Settings.of(Material.METAL).
                    requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL).
    ...
    public static final Block STONE_SOLIDIFIER = registerBlock("stone_solidifier",
            new StoneSolidifierBlock(FabricBlockSettings.of(Material.METAL).
                    requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block FLUID_PUMP = registerBlock("fluid_pump",
            new FluidPumpBlock(FabricBlockSettings.of(Material.METAL).
                    requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block ADVANCED_UNCHARGER = registerBlock("advanced_uncharger",
            new AdvancedUnchargerBlock(FabricBlockSettings.of(Material.METAL).
                    requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block POWERED_LAMP = registerBlock("powered_lamp",
            new PoweredLampBlock(FabricBlockSettings.of(Material.REDSTONE_LAMP).
    ...
    public static final Block ADVANCED_POWERED_FURNACE = registerBlock("advanced_powered_furnace",
            new AdvancedPoweredFurnaceBlock(FabricBlockSettings.of(Material.METAL).
                    requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL).
    ...
    public static final Block TIME_CONTROLLER = registerBlock("time_controller",
            new TimeControllerBlock(FabricBlockSettings.of(Material.METAL).
                    requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
