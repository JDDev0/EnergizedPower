...
public class CreativeBatteryBoxBlock extends BlockWithEntity {
    public static final MapCodec<CreativeBatteryBoxBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, CreativeBatteryBoxBlock::new);
    });
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.CREATIVE_BATTERY_BOX_ENTITY, CreativeBatteryBoxBlockEntity::tick);
    }
