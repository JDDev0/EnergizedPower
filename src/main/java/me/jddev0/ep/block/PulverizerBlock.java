...
public class PulverizerBlock extends BlockWithEntity {
    public static final MapCodec<PulverizerBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, PulverizerBlock::new);
    });

    public static final BooleanProperty POWERED = Properties.POWERED;

    public PulverizerBlock(FabricBlockSettings props) {
        super(props);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.PULVERIZER_ENTITY, PulverizerBlockEntity::tick);
    }
}
