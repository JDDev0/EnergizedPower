...
public class ThermalGeneratorBlock extends BlockWithEntity {
    public static final MapCodec<ThermalGeneratorBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, ThermalGeneratorBlock::new);
    });

    public static final BooleanProperty POWERED = Properties.POWERED;
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    protected ThermalGeneratorBlock(FabricBlockSettings props) {
        super(props);
    ...
    public BlockEntity createBlockEntity(BlockPos blockPos, BlockState state) {
        return new ThermalGeneratorBlockEntity(blockPos, state);
    }
    ...
    public int getComparatorOutput(BlockState state, World level, BlockPos blockPos) {
        ...
        return thermalGeneratorBlockEntity.getRedstoneOutput();
    }
    ...
    public ActionResult onUse(BlockState state, World level, BlockPos blockPos, PlayerEntity player, Hand handItem, BlockHitResult hit) {
        ...
        player.openHandledScreen((ThermalGeneratorBlockEntity)blockEntity);
