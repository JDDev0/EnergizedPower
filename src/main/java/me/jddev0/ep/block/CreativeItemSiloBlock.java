...
public class CreativeItemSiloBlock extends BlockWithEntity {
    ...
    public static class Item extends BlockItem {
        ...
        @Override
        public void appendTooltip(ItemStack stack, TransformerBlock.Item.TooltipContext context, List<Text> tooltip, TooltipType type) {
            if(Screen.hasShiftDown()) {
                tooltip.add(Text.translatable("tooltip.energizedpower.item_silo_capacity.txt",
