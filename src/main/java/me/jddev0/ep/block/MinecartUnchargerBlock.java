...
public class MinecartUnchargerBlock extends BlockWithEntity {
    public static final MapCodec<MinecartUnchargerBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        })).apply(instance, MinecartUnchargerBlock::new);
    });

    public static final DirectionProperty FACING = Properties.FACING;

    protected MinecartUnchargerBlock(FabricBlockSettings props) {
        super(props);
