...
public class UnchargerBlock extends BlockWithEntity {
    public static final MapCodec<UnchargerBlock> CODEC = createCodec(UnchargerBlock::new);

    public static final BooleanProperty POWERED = Properties.POWERED;

    public UnchargerBlock(AbstractBlock.Settings props) {
        super(props);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World level, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, EPBlockEntities.UNCHARGER_ENTITY, UnchargerBlockEntity::tick);
    }
}
