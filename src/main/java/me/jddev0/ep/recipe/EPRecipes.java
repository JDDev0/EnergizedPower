...
public final class EPRecipes {
    ...
    public static final RecipeBookCategory ENERGIZER_CATEGORY = createRecipeCategory("energizer");
    ...
    public static final RecipeBookCategory CHARGER_CATEGORY = createRecipeCategory("charger");
    ...
    public static final RecipeBookCategory CRUSHER_CATEGORY = createRecipeCategory("crusher");
    ...
    public static final RecipeBookCategory SAWMILL_CATEGORY = createRecipeCategory("sawmill");
    ...
    public static final RecipeBookCategory COMPRESSOR_CATEGORY = createRecipeCategory("compressor");
    ...
    public static final RecipeBookCategory PULVERIZER_CATEGORY = createRecipeCategory("pulverizer");
    ...
    public static final RecipeBookCategory PLANT_GROWTH_CHAMBER_CATEGORY = createRecipeCategory("plant_growth_chamber");
    ...
    public static final RecipeBookCategory PLANT_GROWTH_CHAMBER_FERTILIZER_CATEGORY = createRecipeCategory("plant_growth_chamber_fertilizer");
    ...
    public static final RecipeBookCategory HEAT_GENERATOR_CATEGORY = createRecipeCategory("heat_generator");
    ...
    public static final RecipeBookCategory PRESS_MOLD_MAKER_CATEGORY = createRecipeCategory("press_mold_maker");
    ...
    public static final RecipeBookCategory METAL_PRESS_CATEGORY = createRecipeCategory("metal_press");
    ...
    public static final RecipeBookCategory ASSEMBLING_MACHINE_CATEGORY = createRecipeCategory("assembling_machine");
    ...
    public static final RecipeBookCategory STONE_SOLIDIFIER_CATEGORY = createRecipeCategory("stone_solidifier");
    ...
    public static final RecipeBookCategory FLUID_FREEZER_CATEGORY = createRecipeCategory("fluid_freezer");
    ...
    public static final RecipeBookCategory STONE_LIQUEFIER_CATEGORY = createRecipeCategory("stone_liquefier");
    ...
    public static final RecipeBookCategory FILTRATION_PLANT_CATEGORY = createRecipeCategory("filtration_plant");
    ...
    public static final RecipeBookCategory CRYSTAL_GROWTH_CHAMBER_CATEGORY = createRecipeCategory("crystal_growth_chamber");
    ...
    public static final RecipeBookCategory FLUID_TRANSPOSER_CATEGORY = createRecipeCategory("fluid_transposer");
    ...
    public static final RecipeBookCategory ALLOY_FURNACE_CATEGORY = createRecipeCategory("alloy_furnace");
