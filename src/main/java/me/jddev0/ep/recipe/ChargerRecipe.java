...
public class ChargerRecipe implements EnergizedPowerBaseRecipe<RecipeInput> {
    ...
    public ChargerRecipe(ItemStackTemplate output, Ingredient input, int energyConsumption) {
        this.output = output;
        this.input = input;
    ...
    public RecipeBookCategory recipeBookCategory() {
        return EPRecipes.CHARGER_CATEGORY;
    }
    ...
    public static final class Serializer {
        ...
        private static final MapCodec<ChargerRecipe> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        ...
        private static final StreamCodec<RegistryFriendlyByteBuf, ChargerRecipe> STREAM_CODEC = StreamCodec.of(
                Serializer::write, Serializer::read);

        public static final RecipeSerializer<ChargerRecipe> INSTANCE = new RecipeSerializer<>(CODEC, STREAM_CODEC);
