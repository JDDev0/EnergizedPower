...
public class FluidTransposerRecipe implements EnergizedPowerBaseRecipe<RecipeInput> {
    ...
    public FluidTransposerRecipe(FluidTransposerBlockEntity.Mode mode, ItemStackTemplate output, Ingredient input, Either<FluidStack, FluidIngredientWithAmount> fluid) {
        this.mode = mode;
        this.output = output;
        this.input = input;
        this.fluid = fluid;
