...
public class PulverizerRecipe implements EnergizedPowerBaseRecipe<RecipeInput> {
    ...
    public static final class Serializer {
        ...
        private static final MapCodec<PulverizerRecipe> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
            return instance.group(OutputItemStackWithPercentages.createCodec().fieldOf("result").forGetter((recipe) -> {
                return recipe.output;
            }), OutputItemStackWithPercentages.createCodec().optionalFieldOf("secondaryResult").forGetter((recipe) -> {
