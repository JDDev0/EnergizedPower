...
public final class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<Feature> context) {
        ...
        register(context, TIN_ORE_KEY, new OreFeature(List.of(
                BlockReplacement.replace(STONE_ORE_REPLACEABLES, EPBlocks.TIN_ORE.defaultBlockState()),
                BlockReplacement.replace(DEEPSLATE_ORE_REPLACEABLES, EPBlocks.DEEPSLATE_TIN_ORE.defaultBlockState())
        ), 8));
    }
