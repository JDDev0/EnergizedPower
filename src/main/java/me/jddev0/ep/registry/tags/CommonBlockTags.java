...
public final class CommonBlockTags {
    ...
    public static final TagKey<Block> ORES_IN_GROUND_STONE = TagKey.create(Registries.BLOCK,
            Identifier.fromNamespaceAndPath("c", "ores_in_ground/stone"));
    public static final TagKey<Block> ORES_IN_GROUND_DEEPSLATE = TagKey.create(Registries.BLOCK,
