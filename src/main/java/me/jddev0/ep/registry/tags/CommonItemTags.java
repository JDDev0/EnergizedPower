...
public final class CommonItemTags {
    ...
    public static final TagKey<Item> COBBLESTONES_NORMAL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "cobblestones/normal"));

    public static final TagKey<Item> GRAVELS = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "gravels"));

    public static final TagKey<Item> ORES_IN_GROUND_STONE = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores_in_ground/stone"));
    public static final TagKey<Item> ORES_IN_GROUND_DEEPSLATE = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores_in_ground/deepslate"));

    public static final TagKey<Item> ORES_COAL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/coal"));
    public static final TagKey<Item> ORES_TIN = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/tin"));
    public static final TagKey<Item> ORES_COPPER = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/copper"));
    public static final TagKey<Item> ORES_IRON = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/iron"));
    public static final TagKey<Item> ORES_GOLD = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/gold"));
    public static final TagKey<Item> ORES_REDSTONE = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/redstone"));
    public static final TagKey<Item> ORES_LAPIS = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/lapis"));
    public static final TagKey<Item> ORES_EMERALD = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/emerald"));
    public static final TagKey<Item> ORES_DIAMOND = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ores/diamond"));
    ...
    public static final TagKey<Item> NUGGETS_STEEL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "nuggets/steel"));
    ...
    public static final TagKey<Item> INGOTS_CRYSTALLIZED_ALLOY = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "ingots/crystallized_alloy"));
    ...
    public static final TagKey<Item> PLATES_STEEL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "plates/steel"));
    ...
    public static final TagKey<Item> PLATES_CRYSTALLIZED_ALLOY = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "plates/crystallized_alloy"));
    ...
    public static final TagKey<Item> GEARS_STEEL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "gears/steel"));
    ...
    public static final TagKey<Item> RODS_STEEL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "rods/steel"));
    ...
    public static final TagKey<Item> WIRES_SUPERCONDUCTOR = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "wires/superconductor"));
