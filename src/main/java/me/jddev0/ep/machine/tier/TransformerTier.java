...
public enum TransformerTier {
    ...
    public MenuType<TransformerMenu> getMenuTypeFromTierAndType(TransformerType type) {
        return switch(this) {
            ...
            case UHV -> switch(type) {
                case TYPE_1_TO_N -> EPMenuTypes.UHV_TRANSFORMER_1_TO_N_MENU.get();
                case TYPE_3_TO_3 -> EPMenuTypes.UHV_TRANSFORMER_3_TO_3_MENU.get();
                case TYPE_N_TO_1 -> EPMenuTypes.UHV_TRANSFORMER_N_TO_1_MENU.get();
                case CONFIGURABLE -> EPMenuTypes.CONFIGURABLE_UHV_TRANSFORMER_MENU.get();
            };
        };
    }
    ...
    public BlockEntityType<TransformerBlockEntity> getEntityTypeFromTierAndType(TransformerType type) {
        return switch(this) {
            ...
            case UHV -> switch(type) {
                case TYPE_1_TO_N -> EPBlockEntities.UHV_TRANSFORMER_1_TO_N_ENTITY.get();
                case TYPE_3_TO_3 -> EPBlockEntities.UHV_TRANSFORMER_3_TO_3_ENTITY.get();
                case TYPE_N_TO_1 -> EPBlockEntities.UHV_TRANSFORMER_N_TO_1_ENTITY.get();
                case CONFIGURABLE -> EPBlockEntities.CONFIGURABLE_UHV_TRANSFORMER_ENTITY.get();
            };
        };
    }
    ...
    public Block getBlockFromTierAndType(TransformerType type) {
        return switch(this) {
            ...
            case UHV -> switch(type) {
                case TYPE_1_TO_N -> EPBlocks.UHV_TRANSFORMER_1_TO_N.get();
                case TYPE_3_TO_3 -> EPBlocks.UHV_TRANSFORMER_3_TO_3.get();
                case TYPE_N_TO_1 -> EPBlocks.UHV_TRANSFORMER_N_TO_1.get();
                case CONFIGURABLE -> EPBlocks.CONFIGURABLE_UHV_TRANSFORMER.get();
            };
        };
    }
