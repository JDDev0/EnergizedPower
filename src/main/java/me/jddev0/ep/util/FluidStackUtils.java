...
public final class FluidStackUtils {
    ...
    public static FluidStack fromJson(JsonObject json) {
        try {
            Fluid fluid = Registry.FLUID.get(new Identifier(JsonHelper.getString(json, "FluidName")));
    ...
    public static JsonElement toJson(FluidStack fluid) {
        ...
        fluidJson.addProperty("FluidName", Registry.FLUID.getId(fluid.getFluid()).toString());
