...
public class EnergizedPowerModClient {
    ...
    public void onClientSetup(FMLClientSetupEvent event) {
        ...
        onRegisterConditionalItemModelProperties(event);
    }
    ...
    public void registerBlockEntityRenderers() {
        ...
        BlockEntityRenderers.register(EPBlockEntities.TURBO_ITEM_CONVEYOR_BELT_ENTITY.get(), ItemConveyorBeltBlockEntityRenderer::new);
    ...
    public void onRegisterMenuScreens(RegisterMenuScreensEvent e) {
        ...
        event.register(EPMenuTypes.TURBO_ITEM_CONVEYOR_BELT_LOADER_MENU, ItemConveyorBeltLoaderScreen::new);
    ...
    public void onRegisterConditionalItemModelProperties(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
